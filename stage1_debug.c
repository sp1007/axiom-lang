...
extern const ax_u8 ax_FMT_TOKEN_EOF;
const ax_u8 ax_FMT_TOKEN_EOF = 0;
extern const ax_u8 ax_FMT_TOKEN_NEWLINE;
const ax_u8 ax_FMT_TOKEN_NEWLINE = 1;
extern const ax_u8 ax_FMT_TOKEN_WHITESPACE;
const ax_u8 ax_FMT_TOKEN_WHITESPACE = 2;
extern const ax_u8 ax_FMT_TOKEN_COMMENT;
const ax_u8 ax_FMT_TOKEN_COMMENT = 3;
extern const ax_u8 ax_FMT_TOKEN_STRING;
const ax_u8 ax_FMT_TOKEN_STRING = 4;
extern const ax_u8 ax_FMT_TOKEN_CHAR;
const ax_u8 ax_FMT_TOKEN_CHAR = 5;
extern const ax_u8 ax_FMT_TOKEN_NUMBER;
const ax_u8 ax_FMT_TOKEN_NUMBER = 6;
extern const ax_u8 ax_FMT_TOKEN_OPERATOR;
const ax_u8 ax_FMT_TOKEN_OPERATOR = 7;
extern const ax_u8 ax_FMT_TOKEN_PUNCTUATION;
const ax_u8 ax_FMT_TOKEN_PUNCTUATION = 8;
extern const ax_u8 ax_FMT_TOKEN_IDENT;
const ax_u8 ax_FMT_TOKEN_IDENT = 9;
...
ax_u32 ax_SymbolTable_resolve_type(struct ax_SymbolTable self, ax_u32 name_id);
...
ax_u32 ax_TypeTable_register_array(struct ax_TypeTable* self, ax_u32 elem_id, ax_u32 length);
...
void ax_TypeTable_builder_type_size_and_align(struct ax_TypeTable table, ax_u32 type_id, ax_u32* out_size, ax_u32* out_align);
ax_u32 ax_FuncLowering_try_lower_sizeof(struct ax_FuncLowering* self, ax_u32 idx);
...
ax_bool ax_AirFunc_licm_func(struct ax_AirFunc* f);
ax_u32 ax_AirFunc_insert_inst_at(struct ax_AirFunc* f, ax_u32 block_id, ax_u32 pos_in_block, struct ax_AirInst inst);
ax_bool ax_AirFunc_compute_loop_depths(struct ax_AirFunc* f);
ax_bool ax_AirFunc_strength_reduction_func(struct ax_AirFunc* f);
ax_bool ax_AirFunc_loop_unroll_func(struct ax_AirFunc* f);
...
ax_bool ax_reg_is_caller_saved(ax_string abi, ax_u8 r);
struct ax_RegAllocResult ax_LiveIntervalVec_graph_coloring_alloc(struct ax_LiveIntervalVec intervals, ax_u8* avail_regs, ax_i64 avail_regs_len, struct ax_MachInst* insts, ax_i64 insts_len, ax_string abi);
ax_u8* ax_get_used_callee_saved(ax_string abi, struct ax_RegAllocation* allocs, ax_u32 max_vreg, ax_i64* out_len);
struct ax_StackFrame ax_compute_frame(ax_u8* callee_saved, ax_i64 callee_saved_len, ax_i32 spill_count, ax_i32 local_bytes, ax_string abi);
...
void ax_emit_inst(void* file, struct ax_MachInst inst, ax_string fn_name, struct ax_RegAllocation* allocs, ax_string format, struct ax_SymbolTable symbols, struct ax_InternPool pool, struct ax_StackFrame* frame, ax_i32* str_lit_counter);
...
void ax_MachEmitter_emit_function_binary(struct ax_MachEmitter* e, ax_string fn_name, struct ax_MachInst* insts, ax_i64 insts_len, struct ax_RegAllocation* allocs, struct ax_StackFrame* frame, ax_bool is_windows);
...
struct ax_FmtTokenVec ax_new_fmt_token_vec(void);
void ax_FmtTokenVec_push(struct ax_FmtTokenVec* self, struct ax_FmtToken t);
static ax_bool ax_fmt_is_digit(ax_u8 b);
static ax_bool ax_fmt_is_hex_digit(ax_u8 b);
static ax_bool ax_fmt_is_oct_digit(ax_u8 b);
static ax_bool ax_fmt_is_ident_start(ax_u8 b);
static ax_bool ax_fmt_is_ident_part(ax_u8 b);
static ax_bool ax_is_punctuation(ax_string s);
static ax_i64 ax_match_operator_or_punct(ax_string src, ax_i64 i, ax_i64 n);
struct ax_FmtTokenVec ax_scan_tokens(ax_string src);
struct ax_Formatter ax_new_formatter(void);
ax_string ax_Formatter_format(struct ax_Formatter self, ax_string src);
...
static ax_string ax_strip_package_prefixes(ax_string s);
...
ax_u32 ax_SymbolTable_resolve_type(struct ax_SymbolTable self, ax_u32 name_id) {
    ...
    while ((i >= 0)) {
        ...
        struct ax_ScopeEntry entry = ax_Scope_scope_get(((self.scopes.data)[scope_idx]), name_id);
        if ((entry.name_id != ((ax_u32)(0)))) {
            ax_u32 sym_idx = entry.symbol_idx;
            struct ax_Symbol sym = ((self.symbols.data)[sym_idx]);
            if (((((((sym.kind == ax_SYM_STRUCT) || (sym.kind == ax_SYM_INTERFACE)) || (sym.kind == ax_SYM_TYPE_ALIAS)) || (sym.kind == ax_SYM_VARIANT)) || (sym.kind == ax_SYM_GENERIC_PARAM)) || (sym.kind == ax_SYM_BUILTIN_TYPE))) {
                return sym_idx;
            }
        }
        i = (i - 1);
...
void ax_NameResolver_resolve_node(struct ax_NameResolver* self, ax_u32 node_idx) {
    ...
    if ((kind == ax_NODE_PROGRAM)) {
        ...
        if ((((self->tree.nodes.data)[node_idx]).payload != ((ax_u32)(0)))) {
            ax_u32 name_id = ((self->tree.nodes.data)[node_idx]).payload;
            ax_u32 sym_idx = ax_SymbolTable_resolve_type(self->symtable, name_id);
            if ((sym_idx != ((ax_u32)(0)))) {
                ((self->tree.nodes.data)[node_idx]).payload = sym_idx;
                ((self->symtable.symbols.data)[sym_idx]).flags = (((self->symtable.symbols.data)[sym_idx]).flags | ax_SYM_FLAG_USED);
            }
...
ax_u32 ax_TypeTable_register_array(struct ax_TypeTable* self, ax_u32 elem_id, ax_u32 length) {
    ...
    while ((i < self->entries.len)) {
        struct ax_TypeEntry entry = ((self->entries.data)[i]);
        if ((((entry.kind == ax_TYPE_KIND_ARRAY) && (entry.extra == elem_id)) && (entry.name_id == length))) {
            return ((ax_u32)(i));
        }
        i = (i + 1);
    }
    return ax_TypeEntryVec_push(&(self->entries), ((struct ax_TypeEntry){.kind=ax_TYPE_KIND_ARRAY, .padding=((ax_u8)(0)), .flags=((ax_u16)(0)), .name_id=length, .size=((ax_u32)(0)), .align=((ax_u32)(0)), .extra=elem_id}));
}
...
ax_u32 ax_TypeChecker_infer_node(struct ax_TypeChecker* self, ax_u32 node_idx, ax_u32 expected) {
    ...
    if (((kind == ax_NODE_PROGRAM) || (kind == ax_NODE_BLOCK))) {
        ...
        if ((base_idx != ((ax_u32)(0)))) {
            ...
            if (((base_node.kind == ax_NODE_IDENT) || (base_node.kind == ax_NODE_TYPE_EXPR))) {
        ...
        if ((obj != ((ax_u32)(0)))) {
            ...
            if ((obj_type != ax_TYPE_UNKNOWN)) {
                ...
                if ((obj_type == ax_TYPE_STRING)) {
                    ax_u32 field_name_id = ((self->tree.nodes.data)[node_idx]).payload;
                    ax_string field_name = ax_InternPool_get(self->intern, field_name_id);
                    if (ax_str_eq(field_name, (ax_string){.ptr=(const ax_u8*)"ptr", .len=3})) {
                        result_type = ax_TypeTable_register_pointer(&(self->types), ((ax_u32)(5)));
                        ((self->tree.nodes.data)[node_idx]).extra_idx = ((ax_u32)(0));
                    } else if (ax_str_eq(field_name, (ax_string){.ptr=(const ax_u8*)"len", .len=3})) {
                        result_type = ((ax_u32)(4));
                        ((self->tree.nodes.data)[node_idx]).extra_idx = ((ax_u32)(1));
                    }
                    ax_free(((ax_u8*)(field_name.ptr)));
                } else if ((entry.kind == ax_TYPE_KIND_STRUCT)) {
        ...
        ax_u32 length = ((ax_u32)(1));
        if ((inner_node != ((ax_u32)(0)))) {
            ax_u32 size_node = ((self->tree.nodes.data)[inner_node]).next_sibling;
            if (((size_node != ((ax_u32)(0))) && (((self->tree.nodes.data)[size_node]).kind == ax_NODE_INT_LIT))) {
                ax_string text = ax_TypeChecker_node_text(*(self), size_node);
                length = ((ax_u32)(ax_parse_comptime_int(text)));
                ax_free(((ax_u8*)(text.ptr)));
            }
        }
        result_type = ax_TypeTable_register_array(&(self->types), inner_type, length);
...
void ax_TypeTable_builder_type_size_and_align(struct ax_TypeTable table, ax_u32 type_id, ax_u32* out_size, ax_u32* out_align) {
    ...
    if ((entry->kind == ax_TYPE_KIND_PRIMITIVE)) {
        ...
        while ((i < info.fields.len)) {
            ...
            ax_TypeTable_builder_type_size_and_align(table, f.type_id, &(f_size), &(f_align));
            if ((f_align == ((ax_u32)(0)))) {
                f_align = ((ax_u32)(8));
            }
    ...
    } else if ((entry->kind == ax_TYPE_KIND_ARRAY)) {
        ax_u32 elem_id = entry->extra;
        ax_u32 length = entry->name_id;
        ax_u32 elem_size = ((ax_u32)(0));
        ax_u32 elem_align = ((ax_u32)(0));
        ax_TypeTable_builder_type_size_and_align(table, elem_id, &(elem_size), &(elem_align));
        ax_u32 size = (elem_size * length);
        entry->size = size;
...
ax_u32 ax_FuncLowering_try_lower_sizeof(struct ax_FuncLowering* self, ax_u32 idx) {
    ...
    ax_u32 callee_idx = node.first_child;
    if ((callee_idx == ((ax_u32)(0)))) {
        return ((ax_u32)(0));
    }
    struct ax_AstNode callee_node = ((self->mb->tree.nodes.data)[((ax_i64)(callee_idx))]);
    if ((callee_node.kind != ax_NODE_INDEX_EXPR)) {
        return ((ax_u32)(0));
    }
    ax_u32 inner_call_idx = callee_node.first_child;
    if ((inner_call_idx == ((ax_u32)(0)))) {
        return ((ax_u32)(0));
    }
    struct ax_AstNode inner_call_node = ((self->mb->tree.nodes.data)[((ax_i64)(inner_call_idx))]);
    if ((inner_call_node.kind != ax_NODE_CALL_EXPR)) {
        return ((ax_u32)(0));
    }
    ax_u32 inner_callee_idx = inner_call_node.first_child;
    if ((inner_callee_idx == ((ax_u32)(0)))) {
        return ((ax_u32)(0));
    }
    struct ax_AstNode inner_callee_node = ((self->mb->tree.nodes.data)[((ax_i64)(inner_callee_idx))]);
    if ((inner_callee_node.kind != ax_NODE_IDENT)) {
        return ((ax_u32)(0));
    }
    ax_string inner_callee_name = ax_AirModuleBuilder_get_token_text(self->mb, inner_callee_node.token_idx);
    ax_bool is_intrinsic = ax_str_eq(inner_callee_name, (ax_string){.ptr=(const ax_u8*)"compiler_intrinsic", .len=18});
    ax_free(((ax_u8*)(inner_callee_name.ptr)));
    if ((!is_intrinsic)) {
        return ((ax_u32)(0));
    }
    ax_u32 arg_idx = ((self->mb->tree.nodes.data)[((ax_i64)(inner_callee_idx))]).next_sibling;
    if ((arg_idx == ((ax_u32)(0)))) {
        return ((ax_u32)(0));
    }
    struct ax_AstNode arg_node = ((self->mb->tree.nodes.data)[((ax_i64)(arg_idx))]);
    if ((arg_node.kind != ax_NODE_STRING_LIT)) {
        return ((ax_u32)(0));
    }
    ax_string arg_text = ax_AirModuleBuilder_get_token_text(self->mb, arg_node.token_idx);
    ax_bool is_sizeof = ((ax_str_eq(arg_text, (ax_string){.ptr=(const ax_u8*)"\"size_of\"", .len=9}) || ax_str_eq(arg_text, (ax_string){.ptr=(const ax_u8*)"'size_of'", .len=9})) || ax_str_eq(arg_text, (ax_string){.ptr=(const ax_u8*)"size_of", .len=7}));
    ax_free(((ax_u8*)(arg_text.ptr)));
    if ((!is_sizeof)) {
        return ((ax_u32)(0));
    }
    puts((const char*)((ax_string){.ptr=(const ax_u8*)"[Debug] MATCHED size_of call!", .len=29}).ptr);
    ax_u32 type_node_idx = ((self->mb->tree.nodes.data)[((ax_i64)(inner_call_idx))]).next_sibling;
    if ((type_node_idx == ((ax_u32)(0)))) {
        puts((const char*)((ax_string){.ptr=(const ax_u8*)"[Debug]   type_node_idx is 0", .len=28}).ptr);
        return ((ax_u32)(0));
    }
    ax_u32 target_type = ((ax_u32)(0));
    if ((self->mb->node_types != ((ax_u32*)(NULL)))) {
        target_type = ((self->mb->node_types)[((ax_i64)(type_node_idx))]);
    }
    if ((target_type == ((ax_u32)(0)))) {
        struct ax_AstNode type_node = ((self->mb->tree.nodes.data)[((ax_i64)(type_node_idx))]);
        ax_u32 sym_idx = type_node.payload;
        if (((sym_idx != ((ax_u32)(0))) && (((ax_i64)(sym_idx)) < self->mb->symbols.symbols.len))) {
            target_type = ((self->mb->symbols.symbols.data)[((ax_i64)(sym_idx))]).type_id;
        }
    }
    if ((target_type == ((ax_u32)(0)))) {
        puts((const char*)((ax_string){.ptr=(const ax_u8*)"[Debug]   target_type is 0", .len=26}).ptr);
        return ((ax_u32)(0));
    }
    ax_u32 size = ((ax_u32)(0));
    ax_u32 align = ((ax_u32)(0));
    ax_TypeTable_builder_type_size_and_align(self->mb->typetable, target_type, &(size), &(align));
    ax_u32 reg = ax_AirFuncBuilder_fresh_reg(&(self->fb));
    ax_AirFuncBuilder_emit(&(self->fb), ((struct ax_AirInst){.opcode=ax_OP_ICONST, .type_id=((ax_u16)(4)), .dest=reg, .src1=size, .src2=((ax_u32)(0))}));
    return reg;
}
...
ax_u32 ax_FuncLowering_lower_expr(struct ax_FuncLowering* self, ax_u32 idx) {
    ...
    ax_u32 sizeof_reg = ax_FuncLowering_try_lower_sizeof(self, idx);
    if ((sizeof_reg != ((ax_u32)(0)))) {
        return sizeof_reg;
    }
    struct ax_AstNode node = ((self->mb->tree.nodes.data)[((ax_i64)(idx))]);
...
ax_u32 ax_FuncLowering_lower_ident(struct ax_FuncLowering* self, struct ax_AstNode node) {
    ax_string text = ax_AirModuleBuilder_get_token_text(self->mb, node.token_idx);
    if ((ax_str_eq(text, (ax_string){.ptr=(const ax_u8*)"null", .len=4}) || ax_str_eq(text, (ax_string){.ptr=(const ax_u8*)"nil", .len=3}))) {
        ax_free(((ax_u8*)(text.ptr)));
        return ax_FuncLowering_lower_nil_lit(self);
    }
    ax_u32 actual_name_id = ax_InternPool_intern(&(self->mb->pool), text);
    ax_free(((ax_u8*)(text.ptr)));
    ax_bool is_resolved = AX_FALSE;
    ax_u32 sym_idx = ((ax_u32)(0));
    ...
    if (is_resolved) {
        ...
        ax_u32 reg = ax_LocalMap_local_map_get(self->locals, sym_idx);
        return reg;
    }
    return ((ax_u32)(0));
}
...
ax_bool ax_AirFunc_licm_func(struct ax_AirFunc* f) {
    ...
    ax_u32* def_block = ((ax_u32*)(ax_alloc(((((ax_i64)(max_reg)) + ((ax_i64)(1))) * ((ax_i64)(4))))));
    memset(((void*)(def_block)), ((ax_u8)(0xff)), ((((ax_i64)(max_reg)) + ((ax_i64)(1))) * ((ax_i64)(4))));
    ax_i64 bi = ((ax_i64)(0));
    while ((bi < f->blocks.len)) {
        struct ax_BasicBlock blk = ((f->blocks.data)[bi]);
        ax_u32 inst_i = ((ax_u32)(0));
        while ((inst_i < blk.instrs_len)) {
            ax_u32 inst_idx = ((f->block_instrs.data)[(blk.instrs_start + inst_i)]);
            struct ax_AirInst inst = ((f->insts.data)[inst_idx]);
            if (((inst.opcode != ax_OP_NOP) && (inst.dest != ((ax_u32)(0))))) {
                ((def_block)[inst.dest]) = ((ax_u32)(bi));
            }
            inst_i = (inst_i + ((ax_u32)(1)));
        }
        bi = (bi + ((ax_i64)(1)));
    }
    ax_bool changed = AX_FALSE;
    ...
    while ((bi < f->blocks.len)) {
        struct ax_BasicBlock blk = ((f->blocks.data)[bi]);
        if ((blk.loop_depth > ((ax_u8)(0)))) {
            ax_u32 pre_header_id = ((ax_u32)(0xffffffff));
            ax_u32 pred_i = ((ax_u32)(0));
            while ((pred_i < blk.preds_len)) {
                ax_u32 pred = ((f->block_preds.data)[(blk.preds_start + pred_i)]);
                if ((pred < ((ax_u32)(f->blocks.len)))) {
                    if ((((f->blocks.data)[pred]).loop_depth < blk.loop_depth)) {
                        pre_header_id = pred;
                        break;
                    }
                }
                pred_i = (pred_i + ((ax_u32)(1)));
            }
            if ((pre_header_id != ((ax_u32)(0xffffffff)))) {
                ax_u32 inst_i = ((ax_u32)(0));
                while ((inst_i < blk.instrs_len)) {
                    ax_u32 inst_idx = ((f->block_instrs.data)[(blk.instrs_start + inst_i)]);
                    struct ax_AirInst* inst = &(((f->insts.data)[inst_idx]));
                    if ((((inst->opcode != ax_OP_NOP) && (!ax_has_side_effect(inst->opcode))) && (inst->dest != ((ax_u32)(0))))) {
                        ax_bool inv_src1 = AX_TRUE;
                        if (((((inst->src1 != ((ax_u32)(0))) && (inst->opcode != ax_OP_ICONST)) && (inst->opcode != ax_OP_FCONST)) && (inst->opcode != ax_OP_JUMP))) {
                            ax_u32 def_b = ((def_block)[inst->src1]);
                            if ((def_b != ((ax_u32)(0xffffffff)))) {
                                if ((((f->blocks.data)[def_b]).loop_depth >= blk.loop_depth)) {
                                    inv_src1 = AX_FALSE;
                                }
                            }
                        }
                        ax_bool inv_src2 = AX_TRUE;
                        if (((inst->src2 != ((ax_u32)(0))) && (inst->opcode != ax_OP_BRANCH))) {
                            ax_u32 def_b = ((def_block)[inst->src2]);
                            if ((def_b != ((ax_u32)(0xffffffff)))) {
                                if ((((f->blocks.data)[def_b]).loop_depth >= blk.loop_depth)) {
                                    inv_src2 = AX_FALSE;
                                }
                        ...
                        if ((inv_src1 && inv_src2)) {
                            ax_u32 new_inst_idx = ax_AirInstVec_push(&(f->insts), ((struct ax_AirInst){.opcode=inst->opcode, .type_id=inst->type_id, .dest=inst->dest, .src1=inst->src1, .src2=inst->src2}));
                            ((def_block)[inst->dest]) = pre_header_id;
                            struct ax_BasicBlock* ph = &(((f->blocks.data)[pre_header_id]));
                            ax_u32 insert_pos = (ph->instrs_start + ph->instrs_len);
                            ax_U32Vec_push(&(f->block_instrs), ((ax_u32)(0)));
                            ax_i64 shift_i = (f->block_instrs.len - ((ax_i64)(1)));
                            while ((shift_i > ((ax_i64)(insert_pos)))) {
                                ((f->block_instrs.data)[shift_i]) = ((f->block_instrs.data)[(shift_i - ((ax_i64)(1)))]);
                                shift_i = (shift_i - ((ax_i64)(1)));
                            }
                            ((f->block_instrs.data)[insert_pos]) = new_inst_idx;
                            ph->instrs_len = (ph->instrs_len + ((ax_u32)(1)));
                            ax_i64 adjust_bi = (((ax_i64)(pre_header_id)) + ((ax_i64)(1)));
                            while ((adjust_bi < f->blocks.len)) {
                                ((f->blocks.data)[adjust_bi]).instrs_start = (((f->blocks.data)[adjust_bi]).instrs_start + ((ax_u32)(1)));
                                adjust_bi = (adjust_bi + ((ax_i64)(1)));
                            }
                            inst->opcode = ax_OP_NOP;
                            inst->type_id = ((ax_u16)(0));
                            inst->dest = ((ax_u32)(0));
    ...
    ax_free(((ax_u8*)(def_block)));
    return changed;
}

ax_u32 ax_AirFunc_insert_inst_at(struct ax_AirFunc* f, ax_u32 block_id, ax_u32 pos_in_block, struct ax_AirInst inst) {
    ax_u32 new_inst_idx = ax_AirInstVec_push(&(f->insts), inst);
    struct ax_BasicBlock* blk = &(((f->blocks.data)[block_id]));
    ax_u32 insert_pos = (blk->instrs_start + pos_in_block);
    ax_U32Vec_push(&(f->block_instrs), ((ax_u32)(0)));
    ax_i64 shift_i = (f->block_instrs.len - ((ax_i64)(1)));
    while ((shift_i > ((ax_i64)(insert_pos)))) {
        ((f->block_instrs.data)[shift_i]) = ((f->block_instrs.data)[(shift_i - ((ax_i64)(1)))]);
    ...
    ((f->block_instrs.data)[insert_pos]) = new_inst_idx;
    blk->instrs_len = (blk->instrs_len + ((ax_u32)(1)));
    ax_i64 adjust_bi = (((ax_i64)(block_id)) + ((ax_i64)(1)));
    while ((adjust_bi < f->blocks.len)) {
        ((f->blocks.data)[adjust_bi]).instrs_start = (((f->blocks.data)[adjust_bi]).instrs_start + ((ax_u32)(1)));
        adjust_bi = (adjust_bi + ((ax_i64)(1)));
    }
...
ax_bool ax_AirFunc_compute_loop_depths(struct ax_AirFunc* f) {
    ax_i64 bi = ((ax_i64)(0));
    while ((bi < f->blocks.len)) {
        ((f->blocks.data)[bi]).loop_depth = ((ax_u8)(0));
        bi = (bi + ((ax_i64)(1)));
    }
    ax_bool changed = AX_FALSE;
    ax_bool* in_loop = ((ax_bool*)(ax_alloc(f->blocks.len)));
    ax_u32* queue = ((ax_u32*)(ax_alloc((f->blocks.len * ((ax_i64)(4))))));
    ax_u32 b = ((ax_u32)(0));
    while ((b < ((ax_u32)(f->blocks.len)))) {
        struct ax_BasicBlock blk = ((f->blocks.data)[b]);
        ax_u32 succ_i = ((ax_u32)(0));
        while ((succ_i < blk.succs_len)) {
            ax_u32 h = ((f->block_succs.data)[(blk.succs_start + succ_i)]);
            if (((h <= b) && (h < ((ax_u32)(f->blocks.len))))) {
                memset(((void*)(in_loop)), ((ax_u8)(0)), f->blocks.len);
                ((in_loop)[h]) = AX_TRUE;
                ((in_loop)[b]) = AX_TRUE;
                ax_i64 head = ((ax_i64)(0));
                ax_i64 tail = ((ax_i64)(0));
                ...
                while ((head < tail)) {
                    ax_u32 curr = ((queue)[head]);
                    head = (head + ((ax_i64)(1)));
                    struct ax_BasicBlock curr_blk = ((f->blocks.data)[curr]);
                    ax_u32 pred_i = ((ax_u32)(0));
                    while ((pred_i < curr_blk.preds_len)) {
                        ax_u32 pred = ((f->block_preds.data)[(curr_blk.preds_start + pred_i)]);
                        if ((pred < ((ax_u32)(f->blocks.len)))) {
                            if ((!((in_loop)[pred]))) {
                                ((in_loop)[pred]) = AX_TRUE;
                                ((queue)[tail]) = pred;
                                tail = (tail + ((ax_i64)(1)));
                            }
                        }
                ...
                while ((i < f->blocks.len)) {
                    if (((in_loop)[i])) {
                        ax_u8 old_depth = ((f->blocks.data)[i]).loop_depth;
                        if ((old_depth < ((ax_u8)(255)))) {
                            ((f->blocks.data)[i]).loop_depth = (old_depth + ((ax_u8)(1)));
                            changed = AX_TRUE;
                        }
                    }
                    i = (i + ((ax_i64)(1)));
            ...
            succ_i = (succ_i + ((ax_u32)(1)));
        }
        b = (b + ((ax_u32)(1)));
    }
    ax_free(((ax_u8*)(in_loop)));
    ax_free(((ax_u8*)(queue)));
    return changed;
}
...
ax_bool ax_AirFunc_strength_reduction_func(struct ax_AirFunc* f) {
    ...
    ax_bool changed = AX_FALSE;
    ax_u32 next_reg = (max_reg + ((ax_u32)(1)));
    bi = ((ax_i64)(0));
    while ((bi < f->blocks.len)) {
        struct ax_BasicBlock blk = ((f->blocks.data)[bi]);
        if ((blk.loop_depth > ((ax_u8)(0)))) {
            ...
            if ((pre_header_id != ((ax_u32)(0xffffffff)))) {
                ax_u32 iv_reg = ((ax_u32)(0));
                ax_u32 step_val = ((ax_u32)(0));
                ax_u32 step_reg = ((ax_u32)(0));
                ax_bool is_add = AX_TRUE;
                ax_u32 inst_i = ((ax_u32)(0));
                while ((inst_i < blk.instrs_len)) {
                    ax_u32 inst_idx = ((f->block_instrs.data)[(blk.instrs_start + inst_i)]);
                    struct ax_AirInst inst = ((f->insts.data)[inst_idx]);
                    if (((inst.opcode == ax_OP_COPY) && (inst.dest != ((ax_u32)(0))))) {
                        ax_u32 src = inst.src1;
                        ax_u32 src_def_idx = ((f->block_instrs.data)[((blk.instrs_start + inst_i) - ((ax_u32)(1)))]);
                        struct ax_AirInst src_def = ((f->insts.data)[src_def_idx]);
                        if (((src_def.dest == src) && ((src_def.opcode == ax_OP_IADD) || (src_def.opcode == ax_OP_ISUB)))) {
                            if ((src_def.src1 == inst.dest)) {
                                iv_reg = inst.dest;
                                step_reg = src_def.src2;
                                is_add = (src_def.opcode == ax_OP_IADD);
                                break;
                            } else if (((src_def.src2 == inst.dest) && (src_def.opcode == ax_OP_IADD))) {
                                iv_reg = inst.dest;
                ...
                if ((iv_reg != ((ax_u32)(0)))) {
                    ...
                    while ((inst_i < blk.instrs_len)) {
                        ax_u32 inst_idx = ((f->block_instrs.data)[(blk.instrs_start + inst_i)]);
                        struct ax_AirInst* inst = &(((f->insts.data)[inst_idx]));
                        if (((inst->opcode == ax_OP_IMUL) && (inst->dest != ((ax_u32)(0))))) {
                            ax_u32 c_reg = ((ax_u32)(0));
                            if ((inst->src1 == iv_reg)) {
                                c_reg = inst->src2;
                            } else if ((inst->src2 == iv_reg)) {
                                c_reg = inst->src1;
                            }
                            if ((c_reg != ((ax_u32)(0)))) {
                                ax_bool is_invariant = AX_FALSE;
                                ax_u32 c_def_b = ((def_block)[c_reg]);
                                if ((c_def_b == ((ax_u32)(0xffffffff)))) {
                                    is_invariant = AX_TRUE;
                                } else {
                                    {
                                ...
                                if (is_invariant) {
                                    ax_u32 start_reg = ((ax_u32)(0));
                                    struct ax_BasicBlock ph_blk = ((f->blocks.data)[pre_header_id]);
                                    ax_u32 ph_inst_i = ((ax_u32)(0));
                                    while ((ph_inst_i < ph_blk.instrs_len)) {
                                        ax_u32 ph_inst_idx = ((f->block_instrs.data)[(ph_blk.instrs_start + ph_inst_i)]);
                                        struct ax_AirInst ph_inst = ((f->insts.data)[ph_inst_idx]);
                                        if ((((ph_inst.opcode == ax_OP_COPY) || (ph_inst.opcode == ax_OP_MOVE)) && (ph_inst.dest == iv_reg))) {
                                            start_reg = ph_inst.src1;
                                            break;
                                        } else if (((ph_inst.opcode == ax_OP_ICONST) && (ph_inst.dest == iv_reg))) {
                                            start_reg = iv_reg;
                                            break;
                                        }
                                        ph_inst_i = (ph_inst_i + ((ax_u32)(1)));
                                    }
                                    if ((start_reg != ((ax_u32)(0)))) {
                                        ax_u32 acc_reg = next_reg;
                                        next_reg = (next_reg + ((ax_u32)(1)));
                                        struct ax_AirInst init_inst = ((struct ax_AirInst){.opcode=ax_OP_IMUL, .type_id=inst->type_id, .dest=acc_reg, .src1=start_reg, .src2=c_reg});
                                        if ((start_reg == iv_reg)) {
                                            ax_u32 iv_const_val = ((ax_u32)(0));
                                            struct ax_BasicBlock ph_blk2 = ((f->blocks.data)[pre_header_id]);
                                            ax_u32 ph_inst_i2 = ((ax_u32)(0));
                                            while ((ph_inst_i2 < ph_blk2.instrs_len)) {
                                                ax_u32 ph_inst_idx = ((f->block_instrs.data)[(ph_blk2.instrs_start + ph_inst_i2)]);
                                                struct ax_AirInst ph_inst = ((f->insts.data)[ph_inst_idx]);
                                                if (((ph_inst.opcode == ax_OP_ICONST) && (ph_inst.dest == iv_reg))) {
                                                    iv_const_val = ph_inst.src1;
                                                    break;
                                                }
                                                ph_inst_i2 = (ph_inst_i2 + ((ax_u32)(1)));
                                            }
                                            ax_u32 temp_start_reg = next_reg;
                                            next_reg = (next_reg + ((ax_u32)(1)));
                                            ax_AirFunc_insert_inst_at(f, pre_header_id, (ph_blk2.instrs_len - ((ax_u32)(1))), ((struct ax_AirInst){.opcode=ax_OP_ICONST, .type_id=inst->type_id, .dest=temp_start_reg, .src1=iv_const_val, .src2=((ax_u32)(0))}));
                                            init_inst.src1 = temp_start_reg;
                                        }
                                        ax_AirFunc_insert_inst_at(f, pre_header_id, (((f->blocks.data)[pre_header_id]).instrs_len - ((ax_u32)(1))), init_inst);
                                        inst->opcode = ax_OP_COPY;
                                        inst->src1 = acc_reg;
                                        inst->src2 = ((ax_u32)(0));
                                        ax_u32 step_mul_reg = next_reg;
                                        next_reg = (next_reg + ((ax_u32)(1)));
                                        ax_u32 new_acc_reg = next_reg;
                                        next_reg = (next_reg + ((ax_u32)(1)));
                                        ax_u32 copy_pos = ((ax_u32)(0));
                                        ax_u32 loop_inst_i = ((ax_u32)(0));
                                        while ((loop_inst_i < blk.instrs_len)) {
                                            ax_u32 loop_inst_idx = ((f->block_instrs.data)[(blk.instrs_start + loop_inst_i)]);
                                            struct ax_AirInst loop_inst = ((f->insts.data)[loop_inst_idx]);
                                            if (((loop_inst.opcode == ax_OP_COPY) && (loop_inst.dest == iv_reg))) {
                                                copy_pos = (loop_inst_i + ((ax_u32)(1)));
                                                break;
                                            }
                                            loop_inst_i = (loop_inst_i + ((ax_u32)(1)));
                                        }
                                        if ((copy_pos != ((ax_u32)(0)))) {
                                            ax_AirFunc_insert_inst_at(f, ((ax_u32)(bi)), copy_pos, ((struct ax_AirInst){.opcode=ax_OP_IMUL, .type_id=inst->type_id, .dest=step_mul_reg, .src1=step_reg, .src2=c_reg}));
                                            ax_u16 add_op = ((ax_u16)(ax_OP_IADD));
                                            if ((!is_add)) {
                                                add_op = ax_OP_ISUB;
                                            }
                                            ax_AirFunc_insert_inst_at(f, ((ax_u32)(bi)), (copy_pos + ((ax_u32)(1))), ((struct ax_AirInst){.opcode=add_op, .type_id=inst->type_id, .dest=new_acc_reg, .src1=acc_reg, .src2=step_mul_reg}));
                                            ax_AirFunc_insert_inst_at(f, ((ax_u32)(bi)), (copy_pos + ((ax_u32)(2))), ((struct ax_AirInst){.opcode=ax_OP_COPY, .type_id=inst->type_id, .dest=acc_reg, .src1=new_acc_reg, .src2=((ax_u32)(0))}));
                                            changed = AX_TRUE;
                                        }
                                    }
                                }
...
ax_bool ax_AirFunc_loop_unroll_func(struct ax_AirFunc* f) {
    ...
    while ((i < f->insts.len)) {
        struct ax_AirInst inst = ((f->insts.data)[i]);
        if (((inst.opcode == ax_OP_ICONST) && (inst.dest != ((ax_u32)(0))))) {
            ((vals)[inst.dest]) = ((struct ax_ConstVal){.known=AX_TRUE, .val=inst.src1});
        }
        i = (i + ((ax_i64)(1)));
    }
    ...
    while ((bi < f->blocks.len)) {
        ...
        if ((blk.loop_depth > ((ax_u8)(0)))) {
            ...
            if ((pre_header_id != ((ax_u32)(0xffffffff)))) {
                ax_u32 cond_inst_idx = ((ax_u32)(0xffffffff));
                ax_u32 loop_body_block_id = ((ax_u32)(0xffffffff));
                ax_u32 exit_block_id = ((ax_u32)(0xffffffff));
                if ((blk.instrs_len > ((ax_u32)(0)))) {
                    ax_u32 final_inst_idx = ((f->block_instrs.data)[((blk.instrs_start + blk.instrs_len) - ((ax_u32)(1)))]);
                    struct ax_AirInst final_inst = ((f->insts.data)[final_inst_idx]);
                    if ((final_inst.opcode == ax_OP_BRANCH)) {
                        cond_inst_idx = final_inst_idx;
                        exit_block_id = final_inst.dest;
                        loop_body_block_id = final_inst.src2;
                    }
                }
                if ((((cond_inst_idx != ((ax_u32)(0xffffffff))) && (loop_body_block_id < ((ax_u32)(f->blocks.len)))) && (loop_body_block_id != ((ax_u32)(bi))))) {
                    struct ax_AirInst cond_inst = ((f->insts.data)[cond_inst_idx]);
                    ax_u32 cmp_inst_idx = ((ax_u32)(0xffffffff));
                    ax_u32 inst_idx_i = blk.instrs_start;
                    while ((inst_idx_i < (blk.instrs_start + blk.instrs_len))) {
                        ax_u32 idx = ((f->block_instrs.data)[inst_idx_i]);
                        struct ax_AirInst inst = ((f->insts.data)[idx]);
                        if (((inst.dest == cond_inst.src1) && ((inst.opcode == ax_OP_LT) || (inst.opcode == ax_OP_LE)))) {
                            cmp_inst_idx = idx;
                            break;
                        }
                        inst_idx_i = (inst_idx_i + ((ax_u32)(1)));
                    }
                    if ((cmp_inst_idx != ((ax_u32)(0xffffffff)))) {
                        struct ax_AirInst cmp_inst = ((f->insts.data)[cmp_inst_idx]);
                        ax_u32 iv_reg = cmp_inst.src1;
                        ax_u32 limit_reg = cmp_inst.src2;
                        struct ax_ConstVal limit_val_const = ((vals)[limit_reg]);
                        if (limit_val_const.known) {
                            ax_u32 limit_val = limit_val_const.val;
                            ax_u32 start_reg = ((ax_u32)(0));
                            struct ax_BasicBlock ph_blk = ((f->blocks.data)[pre_header_id]);
                            ax_u32 ph_inst_i = ((ax_u32)(0));
                            while ((ph_inst_i < ph_blk.instrs_len)) {
                            ...
                            if ((start_reg != ((ax_u32)(0)))) {
                                ax_u32 start_val = ((ax_u32)(0));
                                ax_bool start_known = AX_FALSE;
                                if ((start_reg == iv_reg)) {
                                    struct ax_BasicBlock ph_blk2 = ((f->blocks.data)[pre_header_id]);
                                    ax_u32 ph_inst_i2 = ((ax_u32)(0));
                                    while ((ph_inst_i2 < ph_blk2.instrs_len)) {
                                    ...
                                    {
                                        struct ax_ConstVal start_val_const = ((vals)[start_reg]);
                                ...
                                if (start_known) {
                                    ax_u32 step_val = ((ax_u32)(1));
                                    struct ax_BasicBlock body_blk = ((f->blocks.data)[loop_body_block_id]);
                                    ax_u32 body_inst_i = ((ax_u32)(0));
                                    while ((body_inst_i < body_blk.instrs_len)) {
                                        ax_u32 b_inst_idx = ((f->block_instrs.data)[(body_blk.instrs_start + body_inst_i)]);
                                        struct ax_AirInst b_inst = ((f->insts.data)[b_inst_idx]);
                                        if (((b_inst.opcode == ax_OP_IADD) && ((b_inst.src1 == iv_reg) || (b_inst.src2 == iv_reg)))) {
                                            ax_u32 step_reg = b_inst.src2;
                                            if ((b_inst.src2 == iv_reg)) {
                                                step_reg = b_inst.src1;
                                            }
                                            struct ax_ConstVal step_val_const = ((vals)[step_reg]);
                                            if (step_val_const.known) {
                                                step_val = step_val_const.val;
                                                break;
                                            }
                                        }
                                        body_inst_i = (body_inst_i + ((ax_u32)(1)));
                                    }
                                    ax_u16 cmp_op = cmp_inst.opcode;
                                    ax_u32 trip_count = ((ax_u32)(0));
                                    if ((cmp_op == ax_OP_LT)) {
                                        if (((limit_val > start_val) && (step_val > ((ax_u32)(0))))) {
                                            trip_count = ((limit_val - start_val) / step_val);
                                        }
                                    } else if ((cmp_op == ax_OP_LE)) {
                                        if (((limit_val >= start_val) && (step_val > ((ax_u32)(0))))) {
                                            trip_count = (((limit_val - start_val) / step_val) + ((ax_u32)(1)));
                                        }
                                    }
                                    if (((trip_count > ((ax_u32)(0))) && (trip_count <= ((ax_u32)(4))))) {
                                        ax_u32* renamed_map = ((ax_u32*)(ax_alloc(((((ax_i64)(max_reg)) + ((ax_i64)(1))) * ((ax_i64)(4))))));
                                        ax_u32 iter = ((ax_u32)(0));
                                        while ((iter < trip_count)) {
                                            ax_u32 curr_iv_val = (start_val + (iter * step_val));
                                            memset(((void*)(renamed_map)), ((ax_u8)(0)), ((((ax_i64)(max_reg)) + ((ax_i64)(1))) * ((ax_i64)(4))));
                                            ax_u32 body_inst_i2 = ((ax_u32)(0));
                                            while ((body_inst_i2 < body_blk.instrs_len)) {
                                                ax_u32 b_inst_idx = ((f->block_instrs.data)[(body_blk.instrs_start + body_inst_i2)]);
                                                struct ax_AirInst b_inst = ((f->insts.data)[b_inst_idx]);
                                                if ((((b_inst.opcode != ax_OP_NOP) && (b_inst.dest != ((ax_u32)(0)))) && (b_inst.dest != iv_reg))) {
                                                    ax_u32 new_reg = next_reg;
                                                    next_reg = (next_reg + ((ax_u32)(1)));
                                                    ((renamed_map)[b_inst.dest]) = new_reg;
                                                }
                                                body_inst_i2 = (body_inst_i2 + ((ax_u32)(1)));
                                            }
                                            ax_u32 temp_iv_reg = next_reg;
                                            next_reg = (next_reg + ((ax_u32)(1)));
                                            ax_AirFunc_insert_inst_at(f, pre_header_id, (((f->blocks.data)[pre_header_id]).instrs_len - ((ax_u32)(1))), ((struct ax_AirInst){.opcode=ax_OP_ICONST, .type_id=((ax_u16)(3)), .dest=temp_iv_reg, .src1=curr_iv_val, .src2=((ax_u32)(0))}));
                                            body_inst_i2 = ((ax_u32)(0));
                                            while ((body_inst_i2 < body_blk.instrs_len)) {
                                                ax_u32 b_inst_idx = ((f->block_instrs.data)[(body_blk.instrs_start + body_inst_i2)]);
                                                struct ax_AirInst b_inst = ((f->insts.data)[b_inst_idx]);
                                                if ((((b_inst.opcode == ax_OP_JUMP) || (b_inst.opcode == ax_OP_BRANCH)) || (b_inst.opcode == ax_OP_NOP))) {
                                                    body_inst_i2 = (body_inst_i2 + ((ax_u32)(1)));
                                                    continue;
                                                }
                                                ax_u32 src1 = b_inst.src1;
                                                if ((((src1 == iv_reg) && (b_inst.opcode != ax_OP_ICONST)) && (b_inst.opcode != ax_OP_FCONST))) {
                                                    src1 = temp_iv_reg;
                                                } else if (((src1 != ((ax_u32)(0))) && (src1 <= max_reg))) {
                                                    if ((((renamed_map)[src1]) != ((ax_u32)(0)))) {
                                                        src1 = ((renamed_map)[src1]);
                                                    }
                                                }
                                                ax_u32 src2 = b_inst.src2;
                                                if (((src2 == iv_reg) && (b_inst.opcode != ax_OP_BRANCH))) {
                                                    src2 = temp_iv_reg;
                                                } else if (((src2 != ((ax_u32)(0))) && (src2 <= max_reg))) {
                                                    if ((((renamed_map)[src2]) != ((ax_u32)(0)))) {
                                                        src2 = ((renamed_map)[src2]);
                                                    }
                                                }
                                                ax_u32 dest = b_inst.dest;
                                                if ((dest == iv_reg)) {
                                                    dest = temp_iv_reg;
                                                } else if (((dest != ((ax_u32)(0))) && (dest <= max_reg))) {
                                                    if ((((renamed_map)[dest]) != ((ax_u32)(0)))) {
                                                        dest = ((renamed_map)[dest]);
                                                    }
                                                }
                                                ax_AirFunc_insert_inst_at(f, pre_header_id, (((f->blocks.data)[pre_header_id]).instrs_len - ((ax_u32)(1))), ((struct ax_AirInst){.opcode=b_inst.opcode, .type_id=b_inst.type_id, .dest=dest, .src1=src1, .src2=src2}));
                                                body_inst_i2 = (body_inst_i2 + ((ax_u32)(1)));
                                            }
                                            if ((iter == (trip_count - ((ax_u32)(1))))) {
                                                body_inst_i2 = ((ax_u32)(0));
                                                while ((body_inst_i2 < body_blk.instrs_len)) {
                                                    ax_u32 b_inst_idx = ((f->block_instrs.data)[(body_blk.instrs_start + body_inst_i2)]);
                                                    struct ax_AirInst b_inst = ((f->insts.data)[b_inst_idx]);
                                                    if ((((b_inst.opcode != ax_OP_NOP) && (b_inst.dest != ((ax_u32)(0)))) && (b_inst.dest != iv_reg))) {
                                                        ax_u32 original_dest = b_inst.dest;
                                                        ax_u32 original_def_b = ((def_block)[original_dest]);
                                                        if (((original_def_b != loop_body_block_id) && (original_def_b != ((ax_u32)(0xffffffff))))) {
                                                            ax_AirFunc_insert_inst_at(f, pre_header_id, (((f->blocks.data)[pre_header_id]).instrs_len - ((ax_u32)(1))), ((struct ax_AirInst){.opcode=ax_OP_COPY, .type_id=b_inst.type_id, .dest=original_dest, .src1=((renamed_map)[original_dest]), .src2=((ax_u32)(0))}));
                                                        }
                                                    }
                                                    body_inst_i2 = (body_inst_i2 + ((ax_u32)(1)));
                                                }
                                        ...
                                        ax_free(((ax_u8*)(renamed_map)));
                                        struct ax_BasicBlock* ph_blk3 = &(((f->blocks.data)[pre_header_id]));
                                        ax_u32 ph_final_idx = ((f->block_instrs.data)[((ph_blk3->instrs_start + ph_blk3->instrs_len) - ((ax_u32)(1)))]);
                                        struct ax_AirInst* ph_final = &(((f->insts.data)[ph_final_idx]));
                                        ph_final->opcode = ax_OP_JUMP;
                                        ph_final->src1 = exit_block_id;
                                        ph_final->src2 = ((ax_u32)(0));
                                        ((f->block_succs.data)[ph_blk3->succs_start]) = exit_block_id;
                                        ph_blk3->succs_len = ((ax_u32)(1));
                                        changed = AX_TRUE;
                                        break;
                                    }
                                }
...
void ax_SsaOptimizer_run(struct ax_SsaOptimizer* self, struct ax_AirModule* m) {
    ...
    while ((fi < m->funcs.len)) {
        ...
        if ((!f->is_extern)) {
            ax_AirFunc_compute_loop_depths(f);
            ax_i32 iter = 0;
            while ((iter < 10)) {
                ax_bool changed = AX_FALSE;
                ...
                if (ax_AirFunc_licm_func(f)) {
                    changed = AX_TRUE;
                }
                if (ax_AirFunc_strength_reduction_func(f)) {
                    changed = AX_TRUE;
                }
                if (ax_AirFunc_loop_unroll_func(f)) {
                    changed = AX_TRUE;
                }
...
void ax_TypeTable_type_size_and_align(struct ax_TypeTable table, ax_u32 type_id, ax_u32* out_size, ax_u32* out_align) {
    ...
    if ((entry->kind == ax_TYPE_KIND_PRIMITIVE)) {
        ...
        ax_u32 elem_size = ((ax_u32)(0));
        ax_u32 elem_align = ((ax_u32)(0));
        ax_TypeTable_type_size_and_align(table, elem_id, &(elem_size), &(elem_align));
        if ((elem_align == ((ax_u32)(0)))) {
            elem_align = ((ax_u32)(8));
        }
        ax_u32 size = (length * elem_size);
        entry->size = size;
        entry->align = elem_align;
        ((out_size)[0]) = size;
        ((out_align)[0]) = elem_align;
...
void ax_InstructionSelector_select_inst(struct ax_InstructionSelector* sel, struct ax_AirInst* inst, struct ax_MachInstVec* out_insts) {
    ...
    if ((op == ax_OP_ICONST)) {
        ...
        if (((inst->src1 == ((ax_u32)(0))) && (!is_str))) {
        ...
        } else {
            {
                ...
                printf((const char*)((ax_string){.ptr=(const ax_u8*)"[Debug select_inst] OP_ICONST dest=%d, type_id=%d, src1=%d, is_str=%d, vreg_flag=%d\n", .len=84}).ptr, ((ax_i64)(inst->dest)), ((ax_i64)(inst->type_id)), ((ax_i64)(inst->src1)), ((ax_i64)(is_str)), ((ax_i64)(vreg_flag)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
                fflush(((void*)(NULL)));
    ...
    } else if ((((op == ax_OP_COPY) || (op == ax_OP_MOVE)) || (op == ax_OP_CAST))) {
        ...
        if (is_syscall) {
            ...
            {
                ax_i64 shadow_size = ((ax_i64)(0));
                if (ax_str_eq(sel->abi_name, (ax_string){.ptr=(const ax_u8*)"win64", .len=5})) {
                    shadow_size = ((ax_i64)(32));
                    if ((arg_count > ((ax_u32)(4)))) {
                        shadow_size = (((ax_i64)(32)) + ((((ax_i64)(arg_count)) - ((ax_i64)(4))) * ((ax_i64)(8))));
                    }
                    shadow_size = ((shadow_size + ((ax_i64)(15))) & (~((ax_i64)(15))));
                } else {
                    {
                        if ((arg_count > ((ax_u32)(6)))) {
                            shadow_size = ((((ax_i64)(arg_count)) - ((ax_i64)(6))) * ((ax_i64)(8)));
                        }
                        shadow_size = ((shadow_size + ((ax_i64)(15))) & (~((ax_i64)(15))));
                    }
                }
                if ((shadow_size > ((ax_i64)(0)))) {
                    ax_MachInstVec_push(out_insts, ((struct ax_MachInst){.op=ax_MACH_SUB, .cc=((ax_u8)(0)), .padding=((ax_u8)(0)), .dst=((struct ax_MachOperand){.kind=ax_OPND_PHYS, .phys=ax_REG_RSP, .padding=((ax_u16)(0)), .vreg=((ax_u32)(0)), .label=((ax_u32)(0)), .imm=((ax_i64)(0))}), .src1=((struct ax_MachOperand){.kind=ax_OPND_IMM, .phys=((ax_u8)(0)), .padding=((ax_u16)(0)), .vreg=((ax_u32)(0)), .label=((ax_u32)(0)), .imm=shadow_size}), .src2=((struct ax_MachOperand){.kind=ax_OPND_NONE, .phys=((ax_u8)(0)), .padding=((ax_u16)(0)), .vreg=((ax_u32)(0)), .label=((ax_u32)(0)), .imm=((ax_i64)(0))})}));
                }
                ax_u32 max_reg_args = ((ax_u32)(4));
                if ((!ax_str_eq(sel->abi_name, (ax_string){.ptr=(const ax_u8*)"win64", .len=5}))) {
                    max_reg_args = ((ax_u32)(6));
                }
                ax_u32 idx_push = arg_count;
                if ((idx_push > max_reg_args)) {
                    idx_push = max_reg_args;
                }
                ax_u32 p_i = idx_push;
                while ((p_i > ((ax_u32)(0)))) {
                    ax_u32 arg_reg = ((sel->fn_ptr->extras.data)[(((arg_start + ((ax_u32)(1))) + p_i) - ((ax_u32)(1)))]);
                    ax_MachInstVec_push(out_insts, ((struct ax_MachInst){.op=ax_MACH_PUSH, .cc=((ax_u8)(0)), .padding=((ax_u8)(0)), .dst=((struct ax_MachOperand){.kind=ax_OPND_NONE, .phys=((ax_u8)(0)), .padding=((ax_u16)(0)), .vreg=((ax_u32)(0)), .label=((ax_u32)(0)), .imm=((ax_i64)(0))}), .src1=((struct ax_MachOperand){.kind=ax_OPND_VREG, .phys=((ax_u8)(0)), .padding=((ax_u16)(0)), .vreg=arg_reg, .label=((ax_u32)(0)), .imm=((ax_i64)(0))}), .src2=((struct ax_MachOperand){.kind=ax_OPND_NONE, .phys=((ax_u8)(0)), .padding=((ax_u16)(0)), .vreg=((ax_u32)(0)), .label=((ax_u32)(0)), .imm=((ax_i64)(0))})}));
                    p_i = (p_i - ((ax_u32)(1)));
                }
                ax_u32 pop_i = ((ax_u32)(0));
                while ((pop_i < idx_push)) {
                    ax_u8 phys = ax_abi_int_arg_reg(sel->abi_name, ((ax_i64)(pop_i)));
                    ax_MachInstVec_push(out_insts, ((struct ax_MachInst){.op=ax_MACH_POP, .cc=((ax_u8)(0)), .padding=((ax_u8)(0)), .dst=((struct ax_MachOperand){.kind=ax_OPND_PHYS, .phys=phys, .padding=((ax_u16)(0)), .vreg=((ax_u32)(0)), .label=((ax_u32)(0)), .imm=((ax_i64)(0))}), .src1=((struct ax_MachOperand){.kind=ax_OPND_NONE, .phys=((ax_u8)(0)), .padding=((ax_u16)(0)), .vreg=((ax_u32)(0)), .label=((ax_u32)(0)), .imm=((ax_i64)(0))}), .src2=((struct ax_MachOperand){.kind=ax_OPND_NONE, .phys=((ax_u8)(0)), .padding=((ax_u16)(0)), .vreg=((ax_u32)(0)), .label=((ax_u32)(0)), .imm=((ax_i64)(0))})}));
                    pop_i = (pop_i + ((ax_u32)(1)));
                }
                ax_u32 i = max_reg_args;
                while ((i < arg_count)) {
                    ax_u32 arg_reg = ((sel->fn_ptr->extras.data)[((arg_start + ((ax_u32)(1))) + i)]);
                    ax_i64 offset = ((ax_i64)(0));
                    if (ax_str_eq(sel->abi_name, (ax_string){.ptr=(const ax_u8*)"win64", .len=5})) {
                        offset = (((ax_i64)(32)) + ((((ax_i64)(i)) - ((ax_i64)(4))) * ((ax_i64)(8))));
                    } else {
                        {
                            offset = ((((ax_i64)(i)) - ((ax_i64)(6))) * ((ax_i64)(8)));
                        }
                    }
                    ax_MachInstVec_push(out_insts, ((struct ax_MachInst){.op=ax_MACH_STORE, .cc=((ax_u8)(0)), .padding=((ax_u8)(0)), .dst=((struct ax_MachOperand){.kind=ax_OPND_PHYS, .phys=ax_REG_RSP, .padding=((ax_u16)(0)), .vreg=((ax_u32)(0)), .label=((ax_u32)(0)), .imm=((ax_i64)(0))}), .src1=((struct ax_MachOperand){.kind=ax_OPND_VREG, .phys=((ax_u8)(0)), .padding=((ax_u16)(0)), .vreg=arg_reg, .label=((ax_u32)(0)), .imm=((ax_i64)(0))}), .src2=((struct ax_MachOperand){.kind=ax_OPND_IMM, .phys=((ax_u8)(0)), .padding=((ax_u16)(0)), .vreg=((ax_u32)(0)), .label=((ax_u32)(0)), .imm=offset})}));
                    i = (i + ((ax_u32)(1)));
                }
        ...
        ax_u32 struct_type = ((ax_u32)(inst->type_id));
        printf((const char*)((ax_string){.ptr=(const ax_u8*)"[Debug] OP_GET_FIELD: type_id=%d, field_idx=%d\n", .len=47}).ptr, ((ax_i64)(struct_type)), ((ax_i64)(inst->src2)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
        ax_u32 disp = ax_TypeTable_field_offset(sel->table, struct_type, inst->src2);
        printf((const char*)((ax_string){.ptr=(const ax_u8*)"[Debug]   -> disp=%d\n", .len=21}).ptr, ((ax_i64)(disp)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
        ...
        ax_u32 struct_type = ((ax_u32)(inst->type_id));
        printf((const char*)((ax_string){.ptr=(const ax_u8*)"[Debug] OP_SET_FIELD: type_id=%d, field_idx=%d\n", .len=47}).ptr, ((ax_i64)(struct_type)), ((ax_i64)(inst->src2)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
        ax_u32 disp = ax_TypeTable_field_offset(sel->table, struct_type, inst->src2);
        printf((const char*)((ax_string){.ptr=(const ax_u8*)"[Debug]   -> disp=%d\n", .len=21}).ptr, ((ax_i64)(disp)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
        ...
        ax_MachInstVec_push(out_insts, ((struct ax_MachInst){.op=ax_MACH_TEST, .cc=((ax_u8)(0)), .padding=((ax_u8)(0)), .dst=((struct ax_MachOperand){.kind=ax_OPND_VREG, .phys=((ax_u8)(0)), .padding=((ax_u16)(0)), .vreg=tmp_cap, .label=((ax_u32)(0)), .imm=((ax_i64)(0))}), .src1=((struct ax_MachOperand){.kind=ax_OPND_VREG, .phys=((ax_u8)(0)), .padding=((ax_u16)(0)), .vreg=tmp_cap, .label=((ax_u32)(0)), .imm=((ax_i64)(0))}), .src2=((struct ax_MachOperand){.kind=ax_OPND_NONE, .phys=((ax_u8)(0)), .padding=((ax_u16)(0)), .vreg=((ax_u32)(0)), .label=((ax_u32)(0)), .imm=((ax_i64)(0))})}));
    ...
    while ((i < insts_len)) {
        ...
        if (((inst->dst.kind == ax_OPND_VREG) && (inst->dst.vreg != ((ax_u32)(0))))) {
            ...
            if ((((interval_map)[v]) == ((struct ax_LiveInterval*)(NULL)))) {
                ...
                iv->vreg = v;
                iv->start = ((ax_i32)(i));
                ax_bool is_param = AX_FALSE;
                if (((inst->op == ax_MACH_MOV) && (inst->src1.kind == ax_OPND_PHYS))) {
                    ax_u8 phys = inst->src1.phys;
                    if (((((((phys == ax_REG_RCX) || (phys == ax_REG_RDX)) || (phys == ax_REG_R8)) || (phys == ax_REG_R9)) || (phys == ax_REG_RDI)) || (phys == ax_REG_RSI))) {
                        is_param = AX_TRUE;
                    }
                }
                if (is_param) {
                    iv->end = ((ax_i32)((insts_len - 1)));
                } else {
                    {
                        iv->end = ((ax_i32)(i));
                    }
...
ax_bool ax_reg_is_caller_saved(ax_string abi, ax_u8 r) {
    if (ax_str_eq(abi, (ax_string){.ptr=(const ax_u8*)"win64", .len=5})) {
        if ((((((((r == ax_REG_RAX) || (r == ax_REG_RCX)) || (r == ax_REG_RDX)) || (r == ax_REG_R8)) || (r == ax_REG_R9)) || (r == ax_REG_R10)) || (r == ax_REG_R11))) {
            return AX_TRUE;
        }
    } else {
        {
...
struct ax_RegAllocResult ax_LiveIntervalVec_graph_coloring_alloc(struct ax_LiveIntervalVec intervals, ax_u8* avail_regs, ax_i64 avail_regs_len, struct ax_MachInst* insts, ax_i64 insts_len, ax_string abi) {
    ...
    ax_i32* param_idx_of_vreg = ((ax_i32*)(ax_alloc((graph_size * 4))));
    ax_i64 param_vi = ((ax_i64)(0));
    while ((param_vi < graph_size)) {
        ((param_idx_of_vreg)[param_vi]) = (-((ax_i32)(1)));
        param_vi = (param_vi + 1);
    }
    ax_i64 inst_idx = ((ax_i64)(0));
    while ((inst_idx < insts_len)) {
        struct ax_MachInst inst = ((insts)[inst_idx]);
        if ((((inst.op == ax_MACH_MOV) && (inst.dst.kind == ax_OPND_VREG)) && (inst.src1.kind == ax_OPND_PHYS))) {
            ax_u8 phys = inst.src1.phys;
            ax_i32 p_idx = (-((ax_i32)(1)));
            if (ax_str_eq(abi, (ax_string){.ptr=(const ax_u8*)"win64", .len=5})) {
                if ((phys == ax_REG_RCX)) {
                    p_idx = ((ax_i32)(0));
                } else if ((phys == ax_REG_RDX)) {
                    p_idx = ((ax_i32)(1));
                } else if ((phys == ax_REG_R8)) {
                    p_idx = ((ax_i32)(2));
                } else if ((phys == ax_REG_R9)) {
                    p_idx = ((ax_i32)(3));
                }
            } else {
                {
                    if ((phys == ax_REG_RDI)) {
                        p_idx = ((ax_i32)(0));
                    } else if ((phys == ax_REG_RSI)) {
                        p_idx = ((ax_i32)(1));
                    } else if ((phys == ax_REG_RDX)) {
                        p_idx = ((ax_i32)(2));
                    } else if ((phys == ax_REG_RCX)) {
                        p_idx = ((ax_i32)(3));
                    } else if ((phys == ax_REG_R8)) {
                        p_idx = ((ax_i32)(4));
                    } else if ((phys == ax_REG_R9)) {
            ...
            if ((p_idx != (-((ax_i32)(1))))) {
                ax_u32 vr = inst.dst.vreg;
                if ((vr < (max_vreg + ((ax_u32)(1))))) {
                    ((param_idx_of_vreg)[((ax_i64)(vr))]) = p_idx;
                }
            }
        }
        inst_idx = (inst_idx + 1);
    }
    ax_bool* spans_call = ((ax_bool*)(ax_alloc(graph_size)));
    memset(((ax_u8*)(spans_call)), ((ax_u8)(0)), graph_size);
    ax_i64 iv_idx = ((ax_i64)(0));
    while ((iv_idx < intervals.len)) {
        ax_u32 vreg = ((intervals.data)[iv_idx]).vreg;
        ax_i32 start = ((intervals.data)[iv_idx]).start;
        ax_i32 end = ((intervals.data)[iv_idx]).end;
        ax_i64 k = ((ax_i64)(start));
        while ((k <= ((ax_i64)(end)))) {
            if (((k >= 0) && (k < insts_len))) {
                ax_u16 op = ((insts)[k]).op;
                if (((op == ax_MACH_CALL) || (op == ax_MACH_CALL_INDIRECT))) {
                    if (((start < ((ax_i32)(k))) && (end > ((ax_i32)(k))))) {
                        ((spans_call)[vreg]) = AX_TRUE;
                        break;
                    }
                }
            }
    ...
    while ((st_idx >= 0)) {
        ...
        ax_i32 p_idx = ((param_idx_of_vreg)[((ax_i64)(vreg))]);
        if ((p_idx != (-((ax_i32)(1))))) {
            ax_i64 j = ((ax_i64)((p_idx + 1)));
            while ((j < ((ax_i64)(6)))) {
                ax_u8 r = ax_abi_int_arg_reg(abi, j);
                if ((r != ax_REG_NONE)) {
                    ((forbidden)[((ax_i64)(r))]) = AX_TRUE;
                }
                j = (j + 1);
            }
        }
        ...
        if (((spans_call)[vreg])) {
            ax_i64 r = ((ax_i64)(0));
            while ((r < 256)) {
                if (ax_reg_is_caller_saved(abi, ((ax_u8)(r)))) {
                    ((forbidden)[r]) = AX_TRUE;
                }
                r = (r + 1);
            }
    ...
    ax_free(((ax_u8*)(spans_call)));
    ax_free(((ax_u8*)(param_idx_of_vreg)));
...
void ax_emit_inst(void* file, struct ax_MachInst inst, ax_string fn_name, struct ax_RegAllocation* allocs, ax_string format, struct ax_SymbolTable symbols, struct ax_InternPool pool, struct ax_StackFrame* frame, ax_i32* str_lit_counter) {
    ...
    if ((op == ax_MACH_NOP)) {
        ...
        if ((inst.src1.vreg == ((ax_u32)(1)))) {
            ...
            ax_string val_str = ax_format_int(inst.src1.imm);
            ax_string sym_name = ax_str_concat((ax_string){.ptr=(const ax_u8*)"Linfo.string.", .len=13}, val_str);
            ax_string len_str = ax_format_int(ax_str_len(ax_InternPool_get(pool, ((ax_u32)(inst.src1.imm)))));
            ax_i32 struct_offset = (((frame->spill_slots * 8) + 16) + (((str_lit_counter)[0]) * 16));
            ax_string struct_offset_str = ax_format_int(((ax_i64)(struct_offset)));
            ax_string len_offset_str = ax_format_int(((ax_i64)((struct_offset - 8))));
            ((str_lit_counter)[0]) = (((str_lit_counter)[0]) + 1);
            if (ax_str_eq(format, (ax_string){.ptr=(const ax_u8*)"winasm", .len=6})) {
                fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    mov %s, OFFSET %s\n", .len=22}).ptr, ((ax_i64)(((ax_u8*)(dst.ptr)))), ((ax_i64)(((ax_u8*)(sym_name.ptr)))), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
                fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    mov qword ptr [rbp - %s], %s\n", .len=33}).ptr, ((ax_i64)(((ax_u8*)(struct_offset_str.ptr)))), ((ax_i64)(((ax_u8*)(dst.ptr)))), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
                fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    mov qword ptr [rbp - %s], %s\n", .len=33}).ptr, ((ax_i64)(((ax_u8*)(len_offset_str.ptr)))), ((ax_i64)(((ax_u8*)(len_str.ptr)))), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
                fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    lea %s, [rbp - %s]\n", .len=23}).ptr, ((ax_i64)(((ax_u8*)(dst.ptr)))), ((ax_i64)(((ax_u8*)(struct_offset_str.ptr)))), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
            } else {
                {
                    fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    mov %s, %s\n", .len=15}).ptr, ((ax_i64)(((ax_u8*)(dst.ptr)))), ((ax_i64)(((ax_u8*)(sym_name.ptr)))), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
                    fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    mov [rbp - %s], %s\n", .len=23}).ptr, ((ax_i64)(((ax_u8*)(struct_offset_str.ptr)))), ((ax_i64)(((ax_u8*)(dst.ptr)))), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
                    fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    mov qword [rbp - %s], %s\n", .len=29}).ptr, ((ax_i64)(((ax_u8*)(len_offset_str.ptr)))), ((ax_i64)(((ax_u8*)(len_str.ptr)))), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
                    fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    lea %s, [rbp - %s]\n", .len=23}).ptr, ((ax_i64)(((ax_u8*)(dst.ptr)))), ((ax_i64)(((ax_u8*)(struct_offset_str.ptr)))), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
                }
            }
            ax_free(((ax_u8*)(sym_name.ptr)));
            ax_free(((ax_u8*)(val_str.ptr)));
            ax_free(((ax_u8*)(len_str.ptr)));
            ax_free(((ax_u8*)(struct_offset_str.ptr)));
            ax_free(((ax_u8*)(len_offset_str.ptr)));
        } else {
            {
                ax_string src = ax_MachOperand_format_operand(inst.src1, format, allocs);
                fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    mov %s, %s\n", .len=15}).ptr, ((ax_i64)(((ax_u8*)(dst.ptr)))), ((ax_i64)(((ax_u8*)(src.ptr)))), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
        ...
        if ((inst.src1.imm <= ((ax_i64)(0)))) {
            ...
            } else if ((inst.src1.imm == (-((ax_i64)(20))))) {
                fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    call TerminateProcess\n", .len=26}).ptr, ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
            } else if ((inst.src1.imm == (-((ax_i64)(10))))) {
                fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    call ax_println_str_native\n", .len=31}).ptr, ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
            } else if ((inst.src1.imm == (-((ax_i64)(11))))) {
                fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    call ax_println_i64\n", .len=24}).ptr, ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
            } else if ((inst.src1.imm == (-((ax_i64)(12))))) {
                fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    call ax_println_f64\n", .len=24}).ptr, ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
            } else if ((inst.src1.imm == (-((ax_i64)(13))))) {
                fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    call ax_println_bool\n", .len=25}).ptr, ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
            } else if ((inst.src1.imm == (-((ax_i64)(14))))) {
                fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    call ax_print_str_native\n", .len=29}).ptr, ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
            } else if ((inst.src1.imm == (-((ax_i64)(15))))) {
                fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    call ax_print_i64\n", .len=22}).ptr, ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
            } else if ((inst.src1.imm == (-((ax_i64)(16))))) {
                fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    call ax_print_f64\n", .len=22}).ptr, ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
            } else if ((inst.src1.imm == (-((ax_i64)(17))))) {
                fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    call ax_print_bool\n", .len=23}).ptr, ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
            } else {
                {
                    if ((inst.src1.imm == ((ax_i64)(0)))) {
                        ...
                        {
                            fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    ; UNKNOWN CALL target IMM: %d\n", .len=34}).ptr, inst.src1.imm, ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
                        }
                    }
                }
            }
...
void ax_emit_function(void* file, ax_string fn_name, struct ax_MachInst* insts, ax_i64 insts_len, struct ax_RegAllocation* allocs, struct ax_StackFrame* frame, ax_string format, struct ax_SymbolTable symbols, struct ax_InternPool pool) {
    ...
    ax_i32 str_lit_counter = ((ax_i32)(0));
    struct ax_MachInstVec prologue = ax_new_mach_inst_vec();
    ax_StackFrame_emit_prologue(frame, &(prologue));
    ax_i64 i = ((ax_i64)(0));
    while ((i < prologue.len)) {
        ax_emit_inst(file, ((prologue.data)[i]), fn_name, allocs, format, symbols, pool, frame, &(str_lit_counter));
        i = (i + 1);
    }
    if ((prologue.data != ((struct ax_MachInst*)(NULL)))) {
        ax_free(((ax_u8*)(prologue.data)));
    }
    ax_bool is_entry = (ax_str_eq(fn_name, (ax_string){.ptr=(const ax_u8*)"main", .len=4}) || ax_str_eq(fn_name, (ax_string){.ptr=(const ax_u8*)"_AX_main_main_v_v", .len=17}));
    i = ((ax_i64)(0));
    while ((i < insts_len)) {
        struct ax_MachInst inst = ((insts)[i]);
        if ((inst.op == ax_MACH_RET)) {
            ...
            while ((j < epilogue.len)) {
                ax_emit_inst(file, ((epilogue.data)[j]), fn_name, allocs, format, symbols, pool, frame, &(str_lit_counter));
                j = (j + 1);
            }
            ...
            if (is_entry) {
                fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    mov rdx, rax\n", .len=17}).ptr, ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
                fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    mov rcx, -1\n", .len=16}).ptr, ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
                fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    sub rsp, 40\n", .len=16}).ptr, ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
                fprintf(file, (const char*)((ax_string){.ptr=(const ax_u8*)"    call TerminateProcess\n", .len=26}).ptr, ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
            } else {
                {
                    ax_emit_inst(file, inst, fn_name, allocs, format, symbols, pool, frame, &(str_lit_counter));
                }
            }
        } else {
            {
...
ax_bool ax_compile_native_asm(ax_string output_asm_file, struct ax_AirModule mod, struct ax_SymbolTable symbols, struct ax_InternPool pool, struct ax_TypeTable table, ax_string format) {
    ...
    while ((fi < mod.funcs.len)) {
        ...
        if ((!fn_ptr->is_extern)) {
            ...
            struct ax_RegAllocResult alloc_res = ax_LiveIntervalVec_graph_coloring_alloc(intervals, avail_gprs, gpr_len, mach_insts.data, mach_insts.len, abi);
            ax_i64 cs_len = ((ax_i64)(0));
            ax_u8* cs_regs = ax_get_used_callee_saved(abi, alloc_res.allocs, alloc_res.max_vreg, &(cs_len));
            struct ax_StackFrame frame = ax_compute_frame(cs_regs, cs_len, alloc_res.spill_count, ((ax_i32)(0)), abi);
...
void ax_x86_encode_lea(ax_u8 dst, ax_u8 base, ax_i32 disp, struct ax_ByteVec* buf) {
    ...
    ax_bool has_rex = (ax_reg_needs_rex(dst) || ax_reg_needs_rex(base));
    if ((has_rex && (temp_buf.len > ((ax_i64)(0))))) {
...
void ax_x86_encode_mov_store(ax_u8 base, ax_i32 disp, ax_u8 src, struct ax_ByteVec* buf) {
    ...
    ax_u8 final_rex = rex;
    ax_i64 start_idx = ((ax_i64)(0));
    ax_bool has_rex = (ax_reg_needs_rex(src) || ax_reg_needs_rex(base));
    if ((has_rex && (temp_buf.len > ((ax_i64)(0))))) {
        ax_u8 first_byte = ((temp_buf.data)[0]);
        if (((first_byte & ((ax_u8)(0xF0))) == ((ax_u8)(0x40)))) {
            final_rex = (final_rex | (first_byte & ((ax_u8)(0x0F))));
...
void ax_MachEmitter_emit_mach_inst(struct ax_MachEmitter* e, struct ax_MachInst inst, struct ax_RegAllocation* allocs) {
    ...
    if ((op == ax_MACH_NOP)) {
        ...
        printf((const char*)((ax_string){.ptr=(const ax_u8*)"[Debug emit_mach_inst] MACH_MOV_IMM dst=%d, vreg_flag=%d, imm=%d\n", .len=65}).ptr, ((ax_i64)(dst)), ((ax_i64)(inst.src1.vreg)), imm, ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
        fflush(((void*)(NULL)));
        if ((dst != ax_REG_NONE)) {
            if ((inst.src1.vreg == ((ax_u32)(1)))) {
...
void ax_MachEmitter_emit_function_binary(struct ax_MachEmitter* e, ax_string fn_name, struct ax_MachInst* insts, ax_i64 insts_len, struct ax_RegAllocation* allocs, struct ax_StackFrame* frame, ax_bool is_windows) {
    ...
    while ((i < insts_len)) {
        ...
        if ((inst.op == ax_MACH_RET)) {
            ...
            if (is_entry) {
                if (is_windows) {
                    ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0x89)));
                    ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0xC2)));
                    ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0x48)));
                    ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0x83)));
                    ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0xC9)));
                    ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0xFF)));
                    ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0x48)));
                    ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0x83)));
                    ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0xEC)));
                    ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0x28)));
                    ax_i64 offset = (e->code.len + ((ax_i64)(1)));
                    ax_RelocationVec_push_reloc(&(e->relocs), ((struct ax_Relocation){.offset=offset, .kind=ax_RELOC_PC32, .padding1=((ax_u8)(0)), .padding2=((ax_u16)(0)), .sym_name=((ax_u32)(4294967276)), .addend=(-((ax_i64)(4)))}));
                    ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0xE8)));
                    ax_ByteVec_push_u32_le(&(e->code), ((ax_u32)(0)));
                } else {
                    {
                        ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0x48)));
                        ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0x89)));
                        ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0xC7)));
                        ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0x48)));
                        ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0xC7)));
                        ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0xC0)));
                        ax_ByteVec_push_u32_le(&(e->code), ((ax_u32)(60)));
                        ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0x0F)));
                        ax_ByteVec_push_byte(&(e->code), ((ax_u8)(0x05)));
                    }
                }
            } else {
                {
...
ax_string ax_resolve_binary_sym_name(ax_i64 sym_idx, ax_string current_fn_name, struct ax_SymbolTable symbols, struct ax_InternPool pool) {
    ...
    if ((sym_idx == (-((ax_i64)(20))))) {
        return (ax_string){.ptr=(const ax_u8*)"TerminateProcess", .len=16};
    }
    ...
    ax_string name = ax_x86_resolve_sym_name(((ax_u32)(sym_idx)), symbols, pool);
    if (ax_str_eq(name, (ax_string){.ptr=(const ax_u8*)"std.string.len", .len=14})) {
        return (ax_string){.ptr=(const ax_u8*)"ax_str_len", .len=10};
    }
    if (ax_str_eq(name, (ax_string){.ptr=(const ax_u8*)"std.string.concat", .len=17})) {
        return (ax_string){.ptr=(const ax_u8*)"ax_str_concat", .len=13};
    }
    if (ax_str_eq(name, (ax_string){.ptr=(const ax_u8*)"std.string.replace", .len=18})) {
        return (ax_string){.ptr=(const ax_u8*)"ax_str_replace", .len=14};
    }
    if (ax_str_eq(name, (ax_string){.ptr=(const ax_u8*)"std.string.slice", .len=16})) {
        return (ax_string){.ptr=(const ax_u8*)"ax_str_slice", .len=12};
    }
    return name;
}
...
ax_bool ax_compile_native_binary(ax_string output_obj_file, struct ax_AirModule mod, struct ax_SymbolTable symbols, struct ax_InternPool pool, struct ax_TypeTable table, ax_string format) {
    ...
    while ((scan_fi < mod.funcs.len)) {
        ...
        if ((!fn_ptr->is_extern)) {
            ax_string fn_name_str = ax_x86_resolve_sym_name(fn_ptr->sym_id, symbols, pool);
            ax_u8* name_nt = ax_str_to_null_terminated(fn_name_str);
            printf((const char*)((ax_string){.ptr=(const ax_u8*)"[Debug Scan Fn] %s has %d insts\n", .len=32}).ptr, ((ax_i64)(name_nt)), ((ax_i64)(fn_ptr->insts.len)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
            fflush(((void*)(NULL)));
            ax_free(name_nt);
            ax_i64 inst_i = ((ax_i64)(0));
            while ((inst_i < fn_ptr->insts.len)) {
                struct ax_AirInst* inst = &(((fn_ptr->insts.data)[inst_i]));
                if ((inst->opcode == ax_OP_ICONST)) {
                    ax_string fn_name_str = ax_x86_resolve_sym_name(fn_ptr->sym_id, symbols, pool);
                    ax_u8* name_nt = ax_str_to_null_terminated(fn_name_str);
                    printf((const char*)((ax_string){.ptr=(const ax_u8*)"[Debug Scan] OP_ICONST in %s: type_id=%d, src1=%d\n", .len=50}).ptr, ((ax_i64)(name_nt)), ((ax_i64)(inst->type_id)), ((ax_i64)(inst->src1)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)), ((ax_i64)(0)));
                    fflush(((void*)(NULL)));
                    ax_free(name_nt);
                }
    ...
    while ((fi < mod.funcs.len)) {
        ...
        if ((!fn_ptr->is_extern)) {
            ...
            fflush(((void*)(NULL)));
            ax_bool is_windows = ax_str_eq(format, (ax_string){.ptr=(const ax_u8*)"coff", .len=4});
            ax_MachEmitter_emit_function_binary(&(emitter), fn_name, final_insts.data, final_insts.len, alloc_res.allocs, &(frame), is_windows);
...
void ax_LinkerSymbolVec_push_linker_symbol(struct ax_LinkerSymbolVec* self, struct ax_LinkerSymbol s) {
    if ((self->len == self->cap)) {
        ...
        struct ax_LinkerSymbol* new_data = ((struct ax_LinkerSymbol*)(ax_alloc((new_cap * 48))));
        if ((self->data != ((struct ax_LinkerSymbol*)(NULL)))) {
            memcpy(((ax_u8*)(new_data)), ((ax_u8*)(self->data)), (self->len * 48));
            ax_free(((ax_u8*)(self->data)));
        }
        self->data = new_data;
        self->cap = new_cap;
...
void ax_ByteVec_linker_build_pe_headers(struct ax_ByteVec* out, ax_u32 code_raw_size, ax_u32 idata_raw_size, ax_u32 entry_rva, ax_u32 idata_rva, ax_u32 idata_size, ax_u32 iat_rva, ax_u32 iat_size) {
    ...
    ax_ByteVec_push_u16_le(out, ((ax_u16)(0x0026)));
    ...
    ax_ByteVec_push_u64_le(out, ((ax_u64)(0x140000000)));
    ax_ByteVec_push_u32_le(out, ((ax_u32)(0x1000)));
    ...
    ax_ByteVec_push_u16_le(out, ((ax_u16)(0x0160)));
...
ax_bool ax_AxiomLinker_axiom_linker_link(struct ax_AxiomLinker* self) {
    ...
    ax_u64 base_addr = ((ax_u64)(0x140001000));
    if (ax_str_eq(format, (ax_string){.ptr=(const ax_u8*)"elf64", .len=5})) {
        if ((thunk_count > 0)) {
    ...
    if ((ax_str_eq(format, (ax_string){.ptr=(const ax_u8*)"coff", .len=4}) && (thunk_count > 0))) {
        ...
        ax_i64 cur_iat_offset = iat_offset;
        if (has_kernel32) {
    ...
    if (ax_str_eq(format, (ax_string){.ptr=(const ax_u8*)"coff", .len=4})) {
        ...
        ax_u32 K_count = ((ax_u32)(0));
        if ((kernel32_imports.len > 0)) {
            K_count = (K_count + ((ax_u32)(1)));
        }
        ...
        ax_u32 idt_size = ((K_count + ((ax_u32)(1))) * ((ax_u32)(20)));
        struct ax_ByteVec pe_headers = ax_new_byte_vec();
        ax_ByteVec_linker_build_pe_headers(&(pe_headers), code_raw_size, idata_raw_size, entry_rva, ((ax_u32)(idata_rva)), idata_raw_size, iat_rva, iat_size);
...
struct ax_FmtTokenVec ax_new_fmt_token_vec(void) {
    return ((struct ax_FmtTokenVec){.data=((struct ax_FmtToken*)(NULL)), .len=0, .cap=0});
}
...
void ax_FmtTokenVec_push(struct ax_FmtTokenVec* self, struct ax_FmtToken t) {
    if ((self->len == self->cap)) {
        ...
        struct ax_FmtToken* new_data = ((struct ax_FmtToken*)(ax_alloc((new_cap * 16))));
        if ((self->data != ((struct ax_FmtToken*)(NULL)))) {
            memcpy(((ax_u8*)(new_data)), ((ax_u8*)(self->data)), (self->len * 16));
            ax_free(((ax_u8*)(self->data)));
        }
        self->data = new_data;
...
static ax_bool ax_fmt_is_digit(ax_u8 b) {
    return ((b >= ((ax_u8)(48))) && (b <= ((ax_u8)(57))));
}

static ax_bool ax_fmt_is_hex_digit(ax_u8 b) {
    return ((ax_fmt_is_digit(b) || ((b >= ((ax_u8)(97))) && (b <= ((ax_u8)(102))))) || ((b >= ((ax_u8)(65))) && (b <= ((ax_u8)(70)))));
}

static ax_bool ax_fmt_is_oct_digit(ax_u8 b) {
    return ((b >= ((ax_u8)(48))) && (b <= ((ax_u8)(55))));
}

static ax_bool ax_fmt_is_ident_start(ax_u8 b) {
    return (((((b >= ((ax_u8)(97))) && (b <= ((ax_u8)(122)))) || ((b >= ((ax_u8)(65))) && (b <= ((ax_u8)(90))))) || (b == ((ax_u8)(95)))) || (b == ((ax_u8)(64))));
}

static ax_bool ax_fmt_is_ident_part(ax_u8 b) {
    return (ax_fmt_is_ident_start(b) || ax_fmt_is_digit(b));
}

static ax_bool ax_is_punctuation(ax_string s) {
    if (((((((((((ax_str_eq(s, (ax_string){.ptr=(const ax_u8*)".", .len=1}) || ax_str_eq(s, (ax_string){.ptr=(const ax_u8*)",", .len=1})) || ax_str_eq(s, (ax_string){.ptr=(const ax_u8*)":", .len=1})) || ax_str_eq(s, (ax_string){.ptr=(const ax_u8*)";", .len=1})) || ax_str_eq(s, (ax_string){.ptr=(const ax_u8*)"(", .len=1})) || ax_str_eq(s, (ax_string){.ptr=(const ax_u8*)")", .len=1})) || ax_str_eq(s, (ax_string){.ptr=(const ax_u8*)"[", .len=1})) || ax_str_eq(s, (ax_string){.ptr=(const ax_u8*)"]", .len=1})) || ax_str_eq(s, (ax_string){.ptr=(const ax_u8*)"{", .len=1})) || ax_str_eq(s, (ax_string){.ptr=(const ax_u8*)"}", .len=1})) || ax_str_eq(s, (ax_string){.ptr=(const ax_u8*)"..", .len=2}))) {
        return AX_TRUE;
    }
    return AX_FALSE;
}
...
static ax_i64 ax_match_operator_or_punct(ax_string src, ax_i64 i, ax_i64 n) {
    if (((i + 1) < n)) {
        ax_string two = ax_str_slice(src, i, (i + 2));
        if (((((((((((((((ax_str_eq(two, (ax_string){.ptr=(const ax_u8*)"**", .len=2}) || ax_str_eq(two, (ax_string){.ptr=(const ax_u8*)"==", .len=2})) || ax_str_eq(two, (ax_string){.ptr=(const ax_u8*)"!=", .len=2})) || ax_str_eq(two, (ax_string){.ptr=(const ax_u8*)"<=", .len=2})) || ax_str_eq(two, (ax_string){.ptr=(const ax_u8*)">=", .len=2})) || ax_str_eq(two, (ax_string){.ptr=(const ax_u8*)"<<", .len=2})) || ax_str_eq(two, (ax_string){.ptr=(const ax_u8*)">>", .len=2})) || ax_str_eq(two, (ax_string){.ptr=(const ax_u8*)":=", .len=2})) || ax_str_eq(two, (ax_string){.ptr=(const ax_u8*)"+=", .len=2})) || ax_str_eq(two, (ax_string){.ptr=(const ax_u8*)"-=", .len=2})) || ax_str_eq(two, (ax_string){.ptr=(const ax_u8*)"*=", .len=2})) || ax_str_eq(two, (ax_string){.ptr=(const ax_u8*)"/=", .len=2})) || ax_str_eq(two, (ax_string){.ptr=(const ax_u8*)"%=", .len=2})) || ax_str_eq(two, (ax_string){.ptr=(const ax_u8*)"->", .len=2})) || ax_str_eq(two, (ax_string){.ptr=(const ax_u8*)"..", .len=2}))) {
            ax_free(((ax_u8*)(two.ptr)));
            return ((ax_i64)(2));
        }
        ax_free(((ax_u8*)(two.ptr)));
    }
    ax_u8 b = ((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i])));
    if ((((((((((((((((((((((((b == 43) || (b == 45)) || (b == 42)) || (b == 47)) || (b == 37)) || (b == 60)) || (b == 62)) || (b == 61)) || (b == 38)) || (b == 124)) || (b == 94)) || (b == 126)) || (b == 33)) || (b == 46)) || (b == 44)) || (b == 58)) || (b == 59)) || (b == 40)) || (b == 41)) || (b == 91)) || (b == 93)) || (b == 123)) || (b == 125))) {
        return ((ax_i64)(1));
    }
    return ((ax_i64)(0));
}
...
struct ax_FmtTokenVec ax_scan_tokens(ax_string src) {
    struct ax_FmtTokenVec tokens = ax_new_fmt_token_vec();
    ax_i64 n = ax_str_len(src);
    ax_i64 i = ((ax_i64)(0));
    while ((i < n)) {
        ax_u8 b = ((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i])));
        if ((b == ((ax_u8)(10)))) {
            ax_FmtTokenVec_push(&(tokens), ((struct ax_FmtToken){.kind=ax_FMT_TOKEN_NEWLINE, .text=(ax_string){.ptr=(const ax_u8*)"\n", .len=1}}));
            i = (i + 1);
            continue;
        }
        if ((((b == ((ax_u8)(47))) && ((i + 1) < n)) && (((ax_u8)((ax_bounds_check((ax_u64)((i + 1)), (src).len), (src).ptr[(i + 1)]))) == ((ax_u8)(47))))) {
            ax_i64 start = i;
            i = (i + 2);
            while (((i < n) && (((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i]))) != ((ax_u8)(10))))) {
                i = (i + 1);
            }
            ax_string text = ax_str_slice(src, start, i);
            ax_FmtTokenVec_push(&(tokens), ((struct ax_FmtToken){.kind=ax_FMT_TOKEN_COMMENT, .text=text}));
            continue;
        }
        if ((((b == ((ax_u8)(32))) || (b == ((ax_u8)(9)))) || (b == ((ax_u8)(13))))) {
            ax_i64 start = i;
            while ((i < n)) {
                ax_u8 ws = ((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i])));
                if ((((ws == ((ax_u8)(32))) || (ws == ((ax_u8)(9)))) || (ws == ((ax_u8)(13))))) {
                    i = (i + 1);
                } else {
                    {
                        break;
            ...
            ax_string text = ax_str_slice(src, start, i);
            ax_FmtTokenVec_push(&(tokens), ((struct ax_FmtToken){.kind=ax_FMT_TOKEN_WHITESPACE, .text=text}));
            continue;
        }
        if ((b == ((ax_u8)(34)))) {
            ax_i64 start = i;
            i = (i + 1);
            ax_bool escaped = AX_FALSE;
            while ((i < n)) {
                if (escaped) {
                    escaped = AX_FALSE;
                } else if ((((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i]))) == ((ax_u8)(92)))) {
                    escaped = AX_TRUE;
                } else if ((((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i]))) == ((ax_u8)(34)))) {
                    i = (i + 1);
                    break;
                }
                i = (i + 1);
            ...
            ax_string text = ax_str_slice(src, start, i);
            ax_FmtTokenVec_push(&(tokens), ((struct ax_FmtToken){.kind=ax_FMT_TOKEN_STRING, .text=text}));
            continue;
        }
        if ((b == ((ax_u8)(39)))) {
            ax_i64 start = i;
            ...
            while ((i < n)) {
                if (escaped) {
                    ...
                    escaped = AX_TRUE;
                } else if ((((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i]))) == ((ax_u8)(39)))) {
                    i = (i + 1);
                    break;
                }
                i = (i + 1);
            ...
            ax_string text = ax_str_slice(src, start, i);
            ax_FmtTokenVec_push(&(tokens), ((struct ax_FmtToken){.kind=ax_FMT_TOKEN_CHAR, .text=text}));
            continue;
        }
        if (ax_fmt_is_digit(b)) {
            ax_i64 start = i;
            if (((b == ((ax_u8)(48))) && ((i + 1) < n))) {
                ax_u8 next = ((ax_u8)((ax_bounds_check((ax_u64)((i + 1)), (src).len), (src).ptr[(i + 1)])));
                if (((next == ((ax_u8)(120))) || (next == ((ax_u8)(88))))) {
                    i = (i + 2);
                    while (((i < n) && (ax_fmt_is_hex_digit(((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i])))) || (((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i]))) == ((ax_u8)(95)))))) {
                        i = (i + 1);
                    }
                    ax_string text = ax_str_slice(src, start, i);
                    ax_FmtTokenVec_push(&(tokens), ((struct ax_FmtToken){.kind=ax_FMT_TOKEN_NUMBER, .text=text}));
                    continue;
                } else if (((next == ((ax_u8)(111))) || (next == ((ax_u8)(79))))) {
                    i = (i + 2);
                    while (((i < n) && (ax_fmt_is_oct_digit(((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i])))) || (((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i]))) == ((ax_u8)(95)))))) {
                        i = (i + 1);
                    }
                    ax_string text = ax_str_slice(src, start, i);
                    ax_FmtTokenVec_push(&(tokens), ((struct ax_FmtToken){.kind=ax_FMT_TOKEN_NUMBER, .text=text}));
                    continue;
                } else if (((next == ((ax_u8)(98))) || (next == ((ax_u8)(66))))) {
                    i = (i + 2);
                    while ((i < n)) {
                        ax_u8 bin = ((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i])));
                        if ((((bin == ((ax_u8)(48))) || (bin == ((ax_u8)(49)))) || (bin == ((ax_u8)(95))))) {
                            i = (i + 1);
                        } else {
                            {
                                break;
            ...
            while ((i < n)) {
                ax_u8 num = ((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i])));
                if ((ax_fmt_is_digit(num) || (num == ((ax_u8)(95))))) {
                    i = (i + 1);
                } else {
                    {
                        break;
            ...
            if (((((i < n) && (((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i]))) == ((ax_u8)(46)))) && ((i + 1) < n)) && ax_fmt_is_digit(((ax_u8)((ax_bounds_check((ax_u64)((i + 1)), (src).len), (src).ptr[(i + 1)])))))) {
                i = (i + 1);
                while ((i < n)) {
                    ax_u8 num = ((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i])));
                    if ((ax_fmt_is_digit(num) || (num == ((ax_u8)(95))))) {
            ...
            if ((i < n)) {
                ax_u8 exp = ((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i])));
                if (((exp == ((ax_u8)(101))) || (exp == ((ax_u8)(69))))) {
                    i = (i + 1);
                    if ((i < n)) {
                        ax_u8 sign = ((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i])));
                        if (((sign == ((ax_u8)(43))) || (sign == ((ax_u8)(45))))) {
                            i = (i + 1);
                        }
                    }
                    while (((i < n) && ax_fmt_is_digit(((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i])))))) {
                        i = (i + 1);
                    }
                }
            }
        ...
        ax_i64 op_len = ax_match_operator_or_punct(src, i, n);
        if ((op_len > 0)) {
            ax_string text = ax_str_slice(src, i, (i + op_len));
            ax_u8 tk = ax_FMT_TOKEN_OPERATOR;
            if (ax_is_punctuation(text)) {
                tk = ax_FMT_TOKEN_PUNCTUATION;
            }
            ax_FmtTokenVec_push(&(tokens), ((struct ax_FmtToken){.kind=tk, .text=text}));
            i = (i + op_len);
            continue;
        }
        if (ax_fmt_is_ident_start(b)) {
            ax_i64 start = i;
            while (((i < n) && ax_fmt_is_ident_part(((ax_u8)((ax_bounds_check((ax_u64)(i), (src).len), (src).ptr[i])))))) {
                i = (i + 1);
            }
            ax_string text = ax_str_slice(src, start, i);
            ax_FmtTokenVec_push(&(tokens), ((struct ax_FmtToken){.kind=ax_FMT_TOKEN_IDENT, .text=text}));
            continue;
        }
        ax_string text = ax_str_slice(src, i, (i + 1));
        ax_FmtTokenVec_push(&(tokens), ((struct ax_FmtToken){.kind=ax_FMT_TOKEN_IDENT, .text=text}));
        i = (i + 1);
    }
    return tokens;
    /* skip destroy for value type tokens */
}

struct ax_Formatter ax_new_formatter(void) {
    return ((struct ax_Formatter){.indent_width=((ax_i64)(4))});
}

ax_string ax_Formatter_format(struct ax_Formatter self, ax_string src) {
    struct ax_FmtTokenVec tokens = ax_scan_tokens(src);
    if ((tokens.len == 0)) {
        return (ax_string){.ptr=(const ax_u8*)"", .len=0};
    }
    ax_i64 total_size = ((ax_i64)(0));
    ax_i64 k = ((ax_i64)(0));
    while ((k < tokens.len)) {
        total_size = ((total_size + ax_str_len(((tokens.data)[k]).text)) + ((ax_i64)(1)));
        k = (k + 1);
    }
    ax_u8* out_buf = ((ax_u8*)(ax_alloc((total_size + ((ax_i64)(8))))));
    ax_i64 out_idx = ((ax_i64)(0));
    k = 0;
    while ((k < tokens.len)) {
        struct ax_FmtToken tok = ((tokens.data)[k]);
        ax_i64 t_len = ax_str_len(tok.text);
        memcpy(((ax_u8*)((((ax_i64)(out_buf)) + out_idx))), ((ax_u8*)(tok.text.ptr)), t_len);
        out_idx = (out_idx + t_len);
        if (((k + 1) < tokens.len)) {
            struct ax_FmtToken next_tok = ((tokens.data)[(k + 1)]);
            if ((((tok.kind == ax_FMT_TOKEN_IDENT) || (tok.kind == ax_FMT_TOKEN_NUMBER)) && (((next_tok.kind == ax_FMT_TOKEN_IDENT) || (next_tok.kind == ax_FMT_TOKEN_NUMBER)) || (next_tok.kind == ax_FMT_TOKEN_OPERATOR)))) {
                ((out_buf)[out_idx]) = ((ax_u8)(32));
                out_idx = (out_idx + 1);
            } else if (((tok.kind == ax_FMT_TOKEN_OPERATOR) || (next_tok.kind == ax_FMT_TOKEN_OPERATOR))) {
                if (((((!ax_str_eq(tok.text, (ax_string){.ptr=(const ax_u8*)"-", .len=1})) && (!ax_str_eq(next_tok.text, (ax_string){.ptr=(const ax_u8*)"-", .len=1}))) && (!ax_str_eq(tok.text, (ax_string){.ptr=(const ax_u8*)"!", .len=1}))) && (!ax_str_eq(next_tok.text, (ax_string){.ptr=(const ax_u8*)"!", .len=1})))) {
                    ((out_buf)[out_idx]) = ((ax_u8)(32));
                    out_idx = (out_idx + 1);
                }
            }
    ...
    k = 0;
    while ((k < tokens.len)) {
        ax_free(((ax_u8*)(((tokens.data)[k]).text.ptr)));
        k = (k + 1);
    }
    if ((tokens.data != ((struct ax_FmtToken*)(NULL)))) {
...
static ax_string ax_strip_package_prefixes(ax_string s) {
    ax_string r1 = ax_str_replace(s, (ax_string){.ptr=(const ax_u8*)"std.mem.alloc.", .len=14}, (ax_string){.ptr=(const ax_u8*)"", .len=0});
    ax_string r2 = ax_str_replace(r1, (ax_string){.ptr=(const ax_u8*)"std.scheduler.", .len=14}, (ax_string){.ptr=(const ax_u8*)"", .len=0});
    if (((((ax_u8*)(r1.ptr)) != ((ax_u8*)(s.ptr))) && (((ax_u8*)(r1.ptr)) != ((ax_u8*)(r2.ptr))))) {
        ax_free(((ax_u8*)(r1.ptr)));
    }
    return r2;
}
...
ax_i32 ax_main_usr(ax_i32 argc, ax_u8** argv) {
    if ((argc < 2)) {
        ...
        puts((const char*)((ax_string){.ptr=(const ax_u8*)"  fmt <file.ax>", .len=15}).ptr);
        return 1;
    }
    ax_bool is_dump_air = AX_FALSE;
    ax_bool is_emit_c = AX_FALSE;
    ax_bool is_build = AX_FALSE;
    ax_bool is_fmt = AX_FALSE;
    ...
    ax_string cmd = ((ax_string){.ptr = (const ax_u8*)(((argv)[1])), .len = strlen((const char*)(((argv)[1])))});
    if (ax_str_eq(cmd, (ax_string){.ptr=(const ax_u8*)"dump-air", .len=8})) {
        is_dump_air = AX_TRUE;
        file_arg_idx = 2;
    } else if (ax_str_eq(cmd, (ax_string){.ptr=(const ax_u8*)"emit-c", .len=6})) {
        is_emit_c = AX_TRUE;
        file_arg_idx = 2;
    } else if (ax_str_eq(cmd, (ax_string){.ptr=(const ax_u8*)"build", .len=5})) {
        is_build = AX_TRUE;
        self_link = AX_TRUE;
        file_arg_idx = 2;
    } else if (ax_str_eq(cmd, (ax_string){.ptr=(const ax_u8*)"fmt", .len=3})) {
        is_fmt = AX_TRUE;
        file_arg_idx = 2;
    } else {
        {
    ...
    while ((opt_idx < argc)) {
        ...
        if ((ax_str_eq(opt, (ax_string){.ptr=(const ax_u8*)"-o", .len=2}) || ax_str_eq(opt, (ax_string){.ptr=(const ax_u8*)"--output", .len=8}))) {
            ...
            self_link = AX_TRUE;
        } else if ((ax_str_eq(opt, (ax_string){.ptr=(const ax_u8*)"-use-gcc", .len=8}) || ax_str_eq(opt, (ax_string){.ptr=(const ax_u8*)"--use-gcc", .len=9}))) {
            self_link = AX_FALSE;
    ...
    if (is_fmt) {
        puts((const char*)((ax_string){.ptr=(const ax_u8*)"[Debug] Running pure-AXIOM Formatter...", .len=39}).ptr);
        struct ax_Formatter formatter = ax_new_formatter();
        ax_string formatted = ax_Formatter_format(formatter, src);
        void* out_file = fopen(((void*)(filename_ptr)), (const char*)((ax_string){.ptr=(const ax_u8*)"wb", .len=2}).ptr);
        if ((out_file != ((void*)(NULL)))) {
            fputs((const char*)(formatted).ptr, out_file);
            fclose(out_file);
            puts((const char*)((ax_string){.ptr=(const ax_u8*)"[Debug] Formatted file successfully!", .len=36}).ptr);
        } else {
            {
                puts((const char*)((ax_string){.ptr=(const ax_u8*)"Error: could not write formatted file", .len=37}).ptr);
            }
        }
        ax_free(((ax_u8*)(formatted.ptr)));
        ax_free(buffer);
        return 0;
    }
    if (self_link) {
        ...
        fflush(((void*)(NULL)));
        ax_string alloc_src_raw = ax_strip_imports(raw_alloc);
        ax_string alloc_src = ax_strip_package_prefixes(alloc_src_raw);
        puts((const char*)((ax_string){.ptr=(const ax_u8*)"[Debug] Stripping imports from scheduler.ax...", .len=46}).ptr);
        fflush(((void*)(NULL)));
        ax_string sched_src_raw = ax_strip_imports(raw_sched);
        ax_string sched_src = ax_strip_package_prefixes(sched_src_raw);
        puts((const char*)((ax_string){.ptr=(const ax_u8*)"[Debug] Stripping imports from runtime.ax...", .len=44}).ptr);
        fflush(((void*)(NULL)));
        ax_string rt_src_raw = ax_strip_imports(raw_rt);
        ax_string rt_src = ax_strip_package_prefixes(rt_src_raw);
        puts((const char*)((ax_string){.ptr=(const ax_u8*)"[Debug] Stripping imports from src...", .len=37}).ptr);
        fflush(((void*)(NULL)));
        ax_string clean_src_raw = ax_strip_imports(src);
        ax_string clean_src = ax_strip_package_prefixes(clean_src_raw);
        ...
        if ((((ax_u8*)(alloc_src.ptr)) != ((ax_u8*)(alloc_src_raw.ptr)))) {
            ax_free(((ax_u8*)(alloc_src.ptr)));
        }
        ax_free(((ax_u8*)(alloc_src_raw.ptr)));
        if ((((ax_u8*)(sched_src.ptr)) != ((ax_u8*)(sched_src_raw.ptr)))) {
            ax_free(((ax_u8*)(sched_src.ptr)));
        }
        ax_free(((ax_u8*)(sched_src_raw.ptr)));
        if ((((ax_u8*)(rt_src.ptr)) != ((ax_u8*)(rt_src_raw.ptr)))) {
            ax_free(((ax_u8*)(rt_src.ptr)));
        }
        ax_free(((ax_u8*)(rt_src_raw.ptr)));
        if ((((ax_u8*)(clean_src.ptr)) != ((ax_u8*)(clean_src_raw.ptr)))) {
            ax_free(((ax_u8*)(clean_src.ptr)));
        }
        ax_free(((ax_u8*)(clean_src_raw.ptr)));
    ...
    if ((!is_dump_air)) {
        ...
        ax_OwnershipChecker_check(&(ownership_chk));
        ...
        ax_EscapeAnalyser_run(&(escape_an));
        ...
        ax_AliasReuseOptimizer_run(&(alias_opt));
    ...
    if (is_dump_air) {
        ...
        ax_string temp_asm = (ax_string){.ptr=(const ax_u8*)"axiom_temp.asm", .len=14};
        ax_compile_native_asm(temp_asm, air_builder->module, resolver.symtable, parser.pool, typetable, (ax_string){.ptr=(const ax_u8*)"nasm", .len=4});
