...
- **BASELINE = 699/699**, đo ở **cả default lẫn `-O0`**. Dưới 699 là RED. (672 → 677 RFC 0038, → 679 libc 0-2, → 682 P6, → 685 RFC 0039, → 689 chẩn đoán 0-1, → 697 chẩn đoán 2b, → 699 libc bước 3.)
