...
- **`Self` type** — ✅ mostly DONE: `-> Self` return resolves to receiver, method chaining works (`575a69a` [[self-type-return-fixed]]); Self-as-param + interface-vtable dispatch still open (niche).
...
## OPEN — tuple × generic element coercion (found 2026-07-13 probing)
