struct AxActor;
int ax_actor_step(struct AxActor* actor);
int ax_actor_is_running(struct AxActor* actor);
int ax_actor_has_messages(struct AxActor* actor);

int ax_actor_step_impl(void* actor_ptr) {
    return ax_actor_step((struct AxActor*)actor_ptr);
}
int ax_actor_is_running_impl(void* actor_ptr) {
    return ax_actor_is_running((struct AxActor*)actor_ptr);
}
int ax_actor_has_messages_impl(void* actor_ptr) {
    return ax_actor_has_messages((struct AxActor*)actor_ptr);
}
...
ax_i32 ax_actor_step_impl(void* actor_ptr);
ax_i32 ax_actor_is_running_impl(void* actor_ptr);
ax_i32 ax_actor_has_messages_impl(void* actor_ptr);
...
void ax_ax_actor_system_init(void) {
    ...
    struct ax_AxActorTable* actor_table = ((struct ax_AxActorTable*)(state->g_actor_table));
    ...
    state->g_actor_table = ((void*)(new_table));
    ...
    state->g_sched = ((void*)(new_sched));
    state->g_sched_initialized = AX_TRUE;
}
...
ax_u64 ax_ax_actor_spawn(void* handler, void* init_data, ax_u64 data_size) {
    ...
    struct ax_AxActorTable* table = ((struct ax_AxActorTable*)(state->g_actor_table));
    ...
    if (state->g_sched_initialized) {
        struct ax_scheduler* sched = ((struct ax_scheduler*)(state->g_sched));
        ...
        while ((j < self->worker_count)) {
            ...
            if ((id != ((ax_u64)(0)))) {
                ...
                if ((actor_ptr != ((void*)(NULL)))) {
                    while ((ax_actor_step_impl(actor_ptr) != ((ax_i32)(0)))) {
                        w->tasks_executed = (w->tasks_executed + ((ax_u64)(1)));
                    }
                    if (((ax_actor_is_running_impl(actor_ptr) != ((ax_i32)(0))) && (ax_actor_has_messages_impl(actor_ptr) != ((ax_i32)(0))))) {
                        ax_runq_push(q, id);
                    }
                }
            }
